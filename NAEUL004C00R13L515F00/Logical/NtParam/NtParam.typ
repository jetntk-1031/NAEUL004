...
TYPE
	tyNtParam : 	STRUCT 
		...
		bLCSLFPrep : BOOL := TRUE;
		bLCSReqRcpPrep : BOOL := TRUE;
		bLCSManageRcpPrep : BOOL := TRUE;
		bLCSLiveDatPrep : BOOL := TRUE;
		...
		tyProdRcpWidth : tyUILmt := (diMax:=460000,diMin:=70000);
