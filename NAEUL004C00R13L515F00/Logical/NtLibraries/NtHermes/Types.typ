...
TYPE
	tyHermesMsgType : 	STRUCT 
		...
		bReplyWorkOrderInfo : BOOL; (*Send Work Order*)
	END_STRUCT;
	eHermesMsgType : 
		(
		HermesMsgTypeNA, (*NA*)
		...
		HermesMsgTypeBoardArrived, (*Board Arrived Received*)
		...
		HermesMsgTypeBoardDeparted, (*Board Departed Received*)
		...
		HermesMsgTypeQueryBypassWOInfo, (*Query Work Order Info*)
		HermesMsgTypeSendWorkOrderInfo, (*Send Work Order Info*)
		HermesMsgTypeReplyWorkOrderInfo (*Send Work Order Info*)
		);
END_TYPE
...
TYPE
	...
	eHermesWorkOrderStatus : 
		(
		HermesWorkOrderRejected := 0, (*The PCB never left and hence is fully inside the upstream machine*)
		HermesWorkOrderAcceptedAndReady := 1, (*The transfer was cancelled in progress*)
		HermesWorkOrderAcceptedAndQueued := 2 (*The transfer ended successfully*)
		);
END_TYPE
...
TYPE
	...
	END_STRUCT;
	tyHermesQueryBypassWOInfo : 	STRUCT 
	END_STRUCT;
	...
	tyHermesReplyWorkOrderInfo : 	STRUCT 
		tyData : tyHermesReplyWorkOrderInfoData;
		tyAvl : tyHermesReplyWorkOrderInfoAvl;
	END_STRUCT;
END_TYPE
...
TYPE
	...
	tyHermesSvyFeature : 	STRUCT 
		...
		bFeatureQueryWorkOrderInfo : BOOL; (*Indication of QueryWorkOrderInfo function implementation.*)
		bFeatureSendWorkOrderInfo : BOOL; (*Indication of SendWorkOrderInfo function implementation.*)
		bFeatureReplyWorkOrderInfo : BOOL; (*Indication of ReplyWorkOrderInfo function implementation.*)
	END_STRUCT;
	...
	tyHermesReplyWorkOrderInfoData : 	STRUCT 
		sWorkOrderId : STRING[80]; (*Identifies the work order for production of the PCB.*)
		sBatchId : STRING[80]; (*The batch id of a splitted work order.*)
		iStatus : INT; (*The weight of the PCB in grams.*)
	END_STRUCT;
...
TYPE
	...
	tyHermesReplyWorkOrderInfoAvl : 	STRUCT 
		bWorkOrderId : BOOL; (*Identifies the work order for production of the PCB.*)
		bBatchId : BOOL; (*The batch id of a splitted work order.*)
		bStatus : BOOL; (*The weight of the PCB in grams.*)
	END_STRUCT;
