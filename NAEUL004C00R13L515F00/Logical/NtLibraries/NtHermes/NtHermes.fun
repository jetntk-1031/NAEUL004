...
FUNCTION_BLOCK fbHermesParseXMLTable (*Hermes Parse XML Table Data*)
	...
	VAR_OUTPUT
		...
		tyQueryBypassWorkOrderInfo : tyHermesQueryWorkOrderInfo; (*Query Work Order Info*)
		iQueryBypassWOInfoFirstIdx : INT; (*Query Work Order Info First Index In Table*)
		iQueryBypassWOInfoLastIdx : INT; (*Query Work Order Info Last Index In Table*)
		...
		tyReplyWorkOrderInfo : tyHermesReplyWorkOrderInfo; (*Send Work Order Info*)
		iReplyWorkOrderInfoFirstIdx : INT; (*Send Work Order Info First Index In Table*)
		iReplyWorkOrderInfoLastIdx : INT; (*Send Work Order Info Last Index In Table*)
	END_VAR
	VAR
...
FUNCTION fHermesParseReplyWorkOrderInfo : BOOL (*Hermes Parse XML Table Data For Send Work Order Info*)
	VAR_INPUT
		p_tyReplyWorkOrderInfo : REFERENCE TO tyHermesReplyWorkOrderInfo; (*Send Work Order Info*)
		tyXMLTableCurr : tyXMLTableDat; (*Pointer To XML Table Current Index*)
		tyXMLTableNxt : tyXMLTableDat; (*Pointer To XML Table Next Index*)
		sCurrValueLowerCase : STRING[254]; (*Current Table Value In Upper Case*)
	END_VAR
...
FUNCTION fHermesFormQueryBypassWOInfo : INT (*Hermes Form Query Work Order Info Table Data (Total Index Written In Table)*)
	VAR_INPUT
		pa_tyXMLTable : REFERENCE TO ARRAY[0..19] OF tyXMLTableDat; (*Output - XML Table Data*)
		tyDTStructure : DTStructure; (*Date And Time Structure*)
		tyParameter : tyHermesQueryWorkOrderInfo; (*Table Data Parameter*)
...
FUNCTION fHermesFormReplyWorkOrderInfo : INT (*Hermes Form Reply Work Order Info Table Data (Total Index Written In Table)*)
	VAR_INPUT
		pa_tyXMLTable : REFERENCE TO ARRAY[0..19] OF tyXMLTableDat; (*Output - XML Table Data*)
		tyDTStructure : DTStructure; (*Date And Time Structure*)
...
FUNCTION fHermesChkParamSWBQW : UDINT (*Hermes Checking Parameter Send Work Order & Query Work Order*)
	VAR_INPUT
		tySendWorkOrderInfo : tyHermesSendWorkOrderInfo; (*Send Work Order Info*)
		tyQueryBypassWorkOrderInfo : tyHermesQueryWorkOrderInfo; (*Query Work Order Info*)
	END_VAR
