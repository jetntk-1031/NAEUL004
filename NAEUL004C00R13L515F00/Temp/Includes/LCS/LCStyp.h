...
#ifndef _BUR_1704680534_124_
#define _BUR_1704680534_124_
...
{	enum eLCSAction eAct;
	...
	plcbit bBlkUS;
	plcbit bBlkDS;
	struct tyMagRcpParam tyMagRcpInfo;
	struct tyMagRcpParam tyCurrMagRcpParam;
