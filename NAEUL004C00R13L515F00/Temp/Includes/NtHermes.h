...
{	HermesMsgTypeNA,
	...
	HermesMsgTypeQueryBypassWOInfo,
...
typedef enum eHermesWorkOrderStatus
{	HermesWorkOrderRejected = 0,
	HermesWorkOrderAcceptedAndReady = 1,
	HermesWorkOrderAcceptedAndQueued = 2
} eHermesWorkOrderStatus;
...
typedef struct tyHermesQueryBypassWOInfo
{
} tyHermesQueryBypassWOInfo;
...
typedef struct fbHermesSequenceDS
{
	...
	plcbit bOpsRun;
	plcbit bSendBFId;
	plcbit bFirstZoneHaveBoard;
	plcbit bFirstZoneEndSen;
	plcbit bAllZonesEmpty;
	/* VAR_OUTPUT (digital) */
	plcbit bUSRdy;
	plcbit bDSRdy;
	plcbit bTransporting;
...
typedef struct fbHermesParseXMLTable
{
	...
	struct tyHermesQueryWorkOrderInfo tyQueryBypassWorkOrderInfo;
	...
	struct tyHermesReplyWorkOrderInfo tyReplyWorkOrderInfo;
...
_BUR_PUBLIC plcbit fHermesParseBoardAvailable(struct tyHermesBoardAvailable** p_tyBoardAvailable, struct tyXMLTableDat* tyXMLTableCurr, struct tyXMLTableDat* tyXMLTableNxt, plcstring* sCurrValueLowerCase);
...
_BUR_PUBLIC plcbit fHermesParseReplyWorkOrderInfo(struct tyHermesReplyWorkOrderInfo** p_tyReplyWorkOrderInfo, struct tyXMLTableDat* tyXMLTableCurr, struct tyXMLTableDat* tyXMLTableNxt, plcstring* sCurrValueLowerCase);
...
_BUR_PUBLIC signed short fHermesFormQueryBypassWOInfo(struct tyXMLTableDat (*pa_tyXMLTable)[20], struct DTStructure* tyDTStructure, struct tyHermesQueryWorkOrderInfo* tyParameter);
...
_BUR_PUBLIC signed short fHermesFormReplyWorkOrderInfo(struct tyXMLTableDat (*pa_tyXMLTable)[20], struct DTStructure* tyDTStructure, struct tyHermesReplyWorkOrderInfo* tyParameter);
...
_BUR_PUBLIC unsigned long fHermesChkParamSWBQW(struct tyHermesSendWorkOrderInfo* tySendWorkOrderInfo, struct tyHermesQueryWorkOrderInfo* tyQueryBypassWorkOrderInfo);
