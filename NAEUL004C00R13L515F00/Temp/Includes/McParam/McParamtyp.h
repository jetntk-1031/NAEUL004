...
#ifndef _BUR_1703817512_29_
#define _BUR_1703817512_29_
...
typedef struct tyMcParamIn1
{	enum eMcParamAction eAct;
	unsigned long udiRstErr;
	struct tyMcParam tyMcParmWr;
	plcstring sProgNm[16];
} tyMcParamIn1;

typedef struct tyMcParamOut1
{	enum eMcParamAction eStat;
	eFBStatus eStatus;
...
typedef struct tyMcParamGen
{	struct tyMcParamIn1 In;
	struct tyMcParamOut1 Out;
} tyMcParamGen;
