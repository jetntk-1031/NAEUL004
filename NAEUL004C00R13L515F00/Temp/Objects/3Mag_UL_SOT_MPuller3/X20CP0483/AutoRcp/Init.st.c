...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/AutoRcp/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AutoRcp/AutoRcp/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AutoRcp/AutoRcp/Init.st"
...
(p_AutoRcpStat=((unsigned long)(&eStat)));
(p_AutoRcpStatus=((unsigned long)(&eStatus)));


(p_AutoRcpAlmData=((unsigned long)(&tyAlmData)));
(p_AutoRcpInfoData=((unsigned long)(&tyInfoData)));
(p_AutoRcpInfoData1=((unsigned long)(&tyInfoData1)));





(p_AutoRcpCurrRcpProdID=((unsigned long)(&sProdtypeID)));
(p_AutoRcpCurrRcpWidth=((unsigned long)(&diProdWidth)));


(p_AutoRcpbTravWidthDiffblk=((unsigned long)(&bTravLifWidthDiffBlk)));



(p_AutoRcpbMag1PropDiffBlk=((unsigned long)(&a_bCheckDifferent[1-1])));
(p_AutoRcpbMag2PropDiffBlk=((unsigned long)(&a_bCheckDifferent[2-1])));
(p_AutoRcpbMag3PropDiffBlk=((unsigned long)(&a_bCheckDifferent[3-1])));

(p_AutoRcpbMagChangeOverBlk=((unsigned long)(&a_bMagChangOverBlk)));

(p_AutoRcpbMag1WidthChg=((unsigned long)(&a_bAllwChangeWidth[1-1])));
(p_AutoRcpbMag2WidthChg=((unsigned long)(&a_bAllwChangeWidth[2-1])));
(p_AutoRcpbMag3WidthChg=((unsigned long)(&a_bAllwChangeWidth[3-1])));

(p_AutoRcpbMag1SlotChg=((unsigned long)(&a_bAllwChangeSlot[1-1])));
(p_AutoRcpbMag2SlotChg=((unsigned long)(&a_bAllwChangeSlot[2-1])));
(p_AutoRcpbMag3SlotChg=((unsigned long)(&a_bAllwChangeSlot[3-1])));

(p_diAutoRcpTravLifWidth=((unsigned long)(&diTravLifWidth)));

(p_diAutoRcpAllMagProps=((unsigned long)(&a_tyMagProps)));
(p_diAutoRcpBrdProps=((unsigned long)(&a_tyCurrZ2Rcp)));


(p_diAutoRcpMag1MaxSlt=((unsigned long)(&a_tyMagProps[1-1].diMaxSlt)));
(p_diAutoRcpMag1MinSlt=((unsigned long)(&a_tyMagProps[1-1].diMinSlt)));
(p_diAutoRcpMag1Pitch=((unsigned long)(&a_tyMagProps[1-1].diPitch)));
(p_diAutoRcpMag1Width=((unsigned long)(&a_tyMagProps[1-1].diWidth)));


(p_diAutoRcpMag2MaxSlt=((unsigned long)(&a_tyMagProps[2-1].diMaxSlt)));
(p_diAutoRcpMag2MinSlt=((unsigned long)(&a_tyMagProps[2-1].diMinSlt)));
(p_diAutoRcpMag2Pitch=((unsigned long)(&a_tyMagProps[2-1].diPitch)));
(p_diAutoRcpMag2Width=((unsigned long)(&a_tyMagProps[2-1].diWidth)));



(p_diAutoRcpMag3MaxSlt=((unsigned long)(&a_tyMagProps[3-1].diMaxSlt)));
(p_diAutoRcpMag3MinSlt=((unsigned long)(&a_tyMagProps[3-1].diMinSlt)));
(p_diAutoRcpMag3Pitch=((unsigned long)(&a_tyMagProps[3-1].diPitch)));
(p_diAutoRcpMag3Width=((unsigned long)(&a_tyMagProps[3-1].diWidth)));


(p_AutoRcpForceExitMag=((unsigned long)(&bForceExitMag)));


}}
#line 74 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AutoRcp/AutoRcp/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/AutoRcp/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/AutoRcp/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AutoRcp/AutoRcp/Init.st\\\"\\n\"");
__asm__(".previous");
