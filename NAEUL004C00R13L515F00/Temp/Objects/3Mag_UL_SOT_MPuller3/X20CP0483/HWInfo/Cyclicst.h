...
#ifndef __AS__TYPE_tysMacAddress
#define __AS__TYPE_tysMacAddress
...
_BUR_LOCAL plcstring(* p_sHMIMacAdd)[28];
...
_BUR_LOCAL plcstring(* p_sSetDefaultGW)[16];
...
_BUR_LOCAL plcstring sSetDefaultGW[16];
...
_BUR_LOCAL struct CfgSetDefaultGateway fbSetDefaultGateway;
_BUR_LOCAL unsigned long udiModuleNum;
_BUR_LOCAL tysMacAddress sMacAddress;
_BUR_LOCAL plcstring sPLCMacAddress[28];
_BUR_LOCAL plcstring sHMIMacAddress[28];
