...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/OpsMagCon1/Cyclicst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.st"
...
#line 28 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Act_InitGlobal.st"
...
(p_bLinkDIMagEntrySen=p_DIMagConvEntSen2);
...
(p_bMag2OrientationChkSen1=p_DIMag2OrientChkSen1);


(p_bMagHeightDetSen2=p_DIHighMagDetSen2);
...
(p_bEn=p_NtParamProjMag2ConvPrep);
(p_bRun=p_OpsRun);
(p_bStop=p_OpsStop);
(p_bStep=p_OpsStep);

(p_sProgNm=p_NtParamOpsMagConvUL2ProgNm);
...
(p_bNewMag=p_UINewMag2);
(p_bRlsMag=p_UIRlsMag2);
...
(p_eBufferStat=p_Buffer2Stat);
(p_eBufferStatus=p_Buffer2Status);

(p_bBufferMagRemoved=p_Buffer2MagRemoved);

(p_eMagConv2ClpStat=p_MagConv2Clp2Stat);
(p_eMagConv2ClpStatus=p_MagConv2Clp2Status);
(p_bMagConv2ClpHvMag=p_MagConv2Clp2HvMag);

(p_eUSSMEMAStat=p_USSMEMA2Stat);
(p_eUSSMEMAStatus=p_USSMEMA2Status);
(p_bUSSMEMATransporting=p_USSMEMA2Transporting);
(p_bUSSMEMAConvStart=p_USSMEMA2ConvStart);
(p_bUSSMEMAConvStop=p_USSMEMA2ConvStop);

(p_eAGVMagStat=p_AGVMag2Stat);
(p_eAGVMagStatus=p_AGVMag2Status);
(p_bAGVMagMcRunRdy=p_AGVMag2McRunRdy);
(p_tyAGVToDTMag=p_AGVTagAGVToDTMag);

(p_eSelClampCtrlStat=p_PneuNoSenSelClamp2Stat);
(p_eSelClampCtrlStatus=p_PneuNoSenSelClamp2Status);



(p_bDIMagConvHeightSen=p_DIMagConvHeightSen2);
(p_bDIMagConvSelUnclampRS=p_DIMag2SelUnclampRS);
(p_bDIMagConvCAB717Sen=p_DIMagConvCAB717MagSen2);
(p_bDIMagConvSmallSen=p_DIMagConvSmallMagSen2);
(p_bDIMagConvLargeSen=p_DIMagConvLargeMagSen2);
(p_bDIOutShutterClosedRS=p_DIOutShutterCloseRS);
(p_bDIOutShutterClosedRS2=p_DIOutShutterCloseRS2);
(p_bNtParamProjOutletShut2Prep=p_NtParamProjOutletShut2Prep);

(p_eNtParamProjMagBuffferActLoad=p_NtParamProjMagBuffferActLoad);

(p_eSafetyBarStat=p_Pneu2SMag2SafetyBarStat);
(p_eSafetyBarStatus=p_Pneu2SMag2SafetyBarStatus);
(p_bSafetyBarExtended=p_Pneu2SMag2SafetyBarExtended);
(p_bSafetyBarRetracted=p_Pneu2SMag2SafetyBarRetracted);

(p_eMagAWEngageStat=p_Pneu2SMag2AWEngageStat);
(p_eMagAWEngageStatus=p_Pneu2SMag2AWEngageStatus);

(p_eMagAWStat=p_MagAWOpen2Stat);
(p_eMagAWStatus=p_MagAWOpen2Status);
(p_bMagAWEngaging=p_MagAWOpen2Engaging);
(p_bMagAWErr=p_MagAWOpen2AxisErr);
(p_bMagAWOpenLimit=p_MagAWOpen2OpenSen);
(p_bMagAWCloseLimit=p_MagAWOpen2CloseSen);


(p_eUSSOTStat=p_USSOT2Stat);
(p_eUSSOTStatus=p_USSOT2Status);
(p_bUSSOTTransporting=p_USSOT2Transporting);
(p_bUSSOTConvStart=p_USSOT2ConvStart);
(p_bUSSOTConvStop=p_USSOT2ConvStop);
(p_bUSSOTUSRdy=p_USSOT2USRdy);
(p_bUSSOTUSLargeMagRdy=p_USSOT2USLargeMagRdy);


(p_eDSSOTStat=p_DSSOT2Stat);
(p_eDSSOTStatus=p_DSSOT2Status);
(p_bDSSOTConvStart=p_DSSOT2ConvStart);
(p_bDSSOTConvStop=p_DSSOT2ConvStop);
...
(p_bDISOTRcv=p_DISOT2Receive);
(p_bDISOTAGVReady=p_DISOT2Ready);
...
(p_bOpsTravLifErrCmdUnclmp=p_OpsTravLifWChkErrCmdUnclmp2);
...
(p_bMagPropDiffBlk=p_AutoRcpbMag2PropDiffBlk);
(p_bChgMagWidth=p_AutoRcpbMag2WidthChg);
(p_bChgMagSlot=p_AutoRcpbMag2SlotChg);

(p_bMagOrientChkSenPrep=p_NtParamProjMagOrientChkSenPrep);
(p_bDIMagFixedClampSen=p_DIMag2FixedClampSen);

(p_eCustomerReq=p_NtParamCustomerReq);

(p_tyResponseFromMES=p_TagFromMesMagConv2);
(p_bOpsTravLifAllwExitMag=p_OpsTravLifAllwExitMag2);
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Act_LinkEn.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Act_Link.st"
static void __AS__Action__Act_Link(void){
{

((*(p_bMagClampRS1))=((((*(p_bLinkFixedMagClampRS1)))&((*(p_bLinkRmtMagClampRS1))))|((*(p_bLinkNewMagVerified1)))));
((*(p_bMagClampRS2))=((((*(p_bLinkFixedMagClampRS2)))&((*(p_bLinkRmtMagClampRS2))))|bNewMagVerified));
...
(fbMagAutoDetTm.IN=(((*(p_bLinkDIMagEntrySen)))|((*(p_bLinkDIMagPresentSen2)))));;(fbMagAutoDetTm.PT=(plctime)((*(p_bLinkMcParamMagAutoDetTm))));;TON(&fbMagAutoDetTm);
...
if(((((unsigned long)(unsigned char)((*(p_bLinkMagRcpCurrRcpMagModel)))==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bDIMagConvHeightSen)))==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(p_bDIMagConvSelUnclampRS)))==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bDIMagConvCAB717Sen)))==(unsigned long)(unsigned char)0))&((*(p_bDIMagConvSmallSen)))&(((((*(p_bMagAWCloseLimit))^1))&(((*(p_bMagAWOpenLimit))^1)))|(((unsigned long)(unsigned char)((*(p_tyBufferStat2)).bBffrMty)==(unsigned long)(unsigned char)0))))){
(bNewMagVerified=1);
...
else if(((((unsigned long)(unsigned char)((*(p_bLinkMagRcpCurrRcpMagModel)))==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(p_bDIMagConvHeightSen)))==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bDIMagConvSelUnclampRS)))==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bDIMagConvCAB717Sen)))==(unsigned long)(unsigned char)0))&((*(p_bDIMagConvSmallSen)))&(((((*(p_bMagAWCloseLimit))^1))&(((*(p_bMagAWOpenLimit))^1)))|(((unsigned long)(unsigned char)((*(p_tyBufferStat2)).bBffrMty)==(unsigned long)(unsigned char)0))))){
(bNewMagVerified=1);
...
(bAIVInPos=(((*(p_tyAGVToDTMag)).bVEHInPos2)|((*(p_bDISOTRcv)))));
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Act_RstErr.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Act_InitLocal.st"
...
(p_dtOpsMagConvUL2AcptTm=((unsigned long)(&dtMagConvAcptTm)));
(p_iOpsMagConvUL2MESAcptCond=((unsigned long)(&iMagMESAcptCond)));
}}
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Act_Initial.st"
static void __AS__Action__Act_Initial(void){
{

if(((*(p_bNtParamProjOutletShut2Prep)))){
(p_bOutShutterExtended=p_Pneu2SenOutShutterExtended2);
}else{
(p_bOutShutterExtended=p_Pneu2SenOutShutterExtended);
}
}imp6_end0_0:;}
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Act_Background.st"
...
if(((((unsigned long)(unsigned char)((*(p_bBufferMagPresent2)))==(unsigned long)(unsigned char)0))|((~((*(p_bMcParamMagAWDis)))&Edge0000300004&1?((Edge0000300004=((*(p_bMcParamMagAWDis)))&1),1):((Edge0000300004=((*(p_bMcParamMagAWDis)))&1),0))&((*(p_tyBufferStat2)).bBffrMty)))){
(bMagAWDone=0);

}


if(((~((*(p_bMcParamMagAWDis)))&Edge0000300005&1?((Edge0000300005=((*(p_bMcParamMagAWDis)))&1),1):((Edge0000300005=((*(p_bMcParamMagAWDis)))&1),0))&(((unsigned long)(unsigned char)((*(p_tyBufferStat2)).bBffrMty)==(unsigned long)(unsigned char)0)))){
(bMagExitedWait=1);
(bNewMagVerified=0);
}
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Act_Alarm.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)g_sOpsMagConvUL2ProgNm; plcstring* zzRValue=(plcstring*)((*(p_sProgNm))); for(zzIndex=0; zzIndex<15l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Act_AlarmInfo1.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Sequence/Act_OpsInitial.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Sequence/Act_OpsRun.st"
...
if((((*(p_bMag2OrientationChkSen1)))&((*(p_bMagHeightDetSen2))))){
(eOpsStep=eGotoOpsStep);
}else{
(eMagConv2ClpAct=27);
...
if((((*(p_bMag2OrientationChkSen1)))&(((*(p_bMagHeightDetSen2))^1)))){
(eOpsStep=eGotoOpsStep);
}else{
(eMagConv2ClpAct=27);
...
(a_bMagAllwMagPresent[2-1]=(((*(p_bBufferMagPresent2)))&(bMagExitedWait^1)));
...
(fbEntSenOff.IN=((((unsigned long)(unsigned char)((*(p_bLocalMagEntrySen)))==(unsigned long)(unsigned char)0))&(((((*(p_bLocalBufferMagPresent)))|((*(p_bMag2OrientationChkSen1))))&((*(p_bProjLifTravMnlLoad))))^1)));;TON(&fbEntSenOff);
...
(bAGVComm2Rdy=(((((signed long)eOpsStep==(signed long)3))|(((signed long)eOpsStep==(signed long)31))|(((signed long)eOpsStep==(signed long)35))|(((signed long)eOpsStep==(signed long)8))|(((signed long)eOpsStep==(signed long)32)))&((*(p_bAGVMagMcRunRdy)))));
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Sequence/Act_OpsInfo.st"
...
if((fbVerifyWarningDelay.Q&(((unsigned long)(unsigned char)((*(p_tyBufferStat2)).bBffrFull)==(unsigned long)(unsigned char)0)))){
if(((((*(p_bMagAWCloseLimit)))|((*(p_bMagAWOpenLimit))))&((*(p_tyBufferStat2)).bBffrMty))){
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Sequence/Act_OpsRst.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Sequence/Act_LogStep.st"
...
__asm__(".ascii \"iecfile \\\"Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/InputRef_Link.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/InputRef.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Local.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/OpsMagCon1/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/OpsMagCon1/Cyclic.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Cyclic.st\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/OpsMagCon1/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");
