...
_BUR_LOCAL plcbit(* p_bLinkPullConvPullerExtCtrl);
_BUR_LOCAL plcbit(* p_bLinkPullConvPullerRetCtrl);
_BUR_LOCAL plcbit(* p_bLinkDIPullerExtRS);
_BUR_LOCAL plcbit(* p_bLinkDIPullerRetRS);
_BUR_LOCAL plcbit(* p_bLinkDIPullerExtSlwRS);
_BUR_LOCAL plcbit(* p_bLinkDIPullerRetSlwRS);
_BUR_LOCAL signed long(* p_dintLinkPullerRetSpd);
_BUR_LOCAL signed long(* p_dintLinkPullerRetTrq);
_BUR_LOCAL signed long(* p_diLinkProdRcpTrq);
_BUR_LOCAL struct PPTorqParam(* p_tyLinkTorqParam);
_BUR_LOCAL ePullerPusherAction(* p_eAct);
...
_BUR_LOCAL plcbit(* p_bMagWidthChkSen);
_BUR_LOCAL plcbit(* p_bInletShutterCloseRS);
_BUR_LOCAL signed long(* p_diServoTorque);
_BUR_LOCAL ePullerPusherAction eAct;
...
_BUR_LOCAL unsigned char usiJogFwdStep;
_BUR_LOCAL unsigned char usiJogRevStep;
_BUR_LOCAL plcbit bJogRevDone;
_BUR_LOCAL plcbit bJogFwdDone;
_BUR_LOCAL plcbit bJogStopDone;
_BUR_LOCAL signed long diServoTorque;
_BUR_LOCAL unsigned long udiMaxTorque;
_BUR_LOCAL signed long diRetSpd;
...
_BUR_LOCAL signed long diMtrPshrExtTrq;
_BUR_LOCAL plcbit bModuleNotOKLock;
_BUR_LOCAL plcbit bNotInterruptible;
_BUR_LOCAL signed long diSlowSpeed;
_BUR_LOCAL signed long diExtSlowSpeed;
...
_BUR_LOCAL struct CANopenSDOWrite8 fbSDOWriteTorque;
...
_GLOBAL unsigned long p_StartupServoPPAct;
...
_LOCAL plcbit Edge0001200003;
_LOCAL plcbit Edge0001200004;
