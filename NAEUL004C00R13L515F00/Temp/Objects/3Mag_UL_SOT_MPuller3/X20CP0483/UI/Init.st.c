...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/UI/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/UI/UI/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/UI/UI/Init.st"
...
(p_UIMagRcpAct=((unsigned long)(&eMagRcpAct)));
(p_UIMcParamAct=((unsigned long)(&eMcParamAct)));
(p_UIUsrMgmtAct=((unsigned long)(&eUsrMgmtAct)));
(p_UIOvenInfoAAct=((unsigned long)(&eOvenInfoAAct)));
(p_UIOvenInfoBAct=((unsigned long)(&eOvenInfoBAct)));
(p_UIBuffer1Act=((unsigned long)(&eBuffer1Act)));
(p_UIBuffer2Act=((unsigned long)(&eBuffer2Act)));
(p_UIBuffer3Act=((unsigned long)(&eBuffer3Act)));
(p_UIUSSMEMAAAct=((unsigned long)(&eUSSMEMAAAct)));
(p_UIUSSMEMABAct=((unsigned long)(&eUSSMEMABAct)));
(p_UIInShutterAct=((unsigned long)(&eInShutterAct)));
(p_UIOutShutterAct=((unsigned long)(&eOutShutterAct)));
(p_UIOutShutterAct2=((unsigned long)(&eOutShutterAct2)));
(p_UIOutShutterAct3=((unsigned long)(&eOutShutterAct3)));
(p_UIStopperAAct=((unsigned long)(&eStopperAAct)));
(p_UIStopperBAct=((unsigned long)(&eStopperBAct)));
(p_UIInStopperAct=((unsigned long)(&eInStopperAct)));
(p_UIMag1SafetyBarAct=((unsigned long)(&eMag1SafetyBarAct)));
(p_UIMag2SafetyBarAct=((unsigned long)(&eMag2SafetyBarAct)));
(p_UIMag3SafetyBarAct=((unsigned long)(&eMag3SafetyBarAct)));
(p_UIMag1AWEngageAct=((unsigned long)(&eMag1AWEngageAct)));
(p_UIMag2AWEngageAct=((unsigned long)(&eMag2AWEngageAct)));
(p_UIMag3AWEngageAct=((unsigned long)(&eMag3AWEngageAct)));
(p_UIPshrConvAct=((unsigned long)(&ePshrConvAct)));

(p_UIMagConvSelClp1Act=((unsigned long)(&eMagConvSelClp1Act)));
(p_UIMagConvSelClp2Act=((unsigned long)(&eMagConvSelClp2Act)));
(p_UIMagConvSelClp3Act=((unsigned long)(&eMagConvSelClp3Act)));
(p_UIMagConv2Clp1Act=((unsigned long)(&eMagConv2Clp1Act)));
(p_UIMagConv2Clp2Act=((unsigned long)(&eMagConv2Clp2Act)));
(p_UIMagConv2Clp3Act=((unsigned long)(&eMagConv2Clp3Act)));

(p_UIAWPushOrPullerAct=((unsigned long)(&eAWPushOrPullerAct)));
(p_UIAWOpenAct=((unsigned long)(&eAWOpenAct)));
(p_UILifterBtmAct=((unsigned long)(&eLifterBtmAct)));
(p_UILifter2Act=((unsigned long)(&eLifter2Act)));
(p_UITravAct=((unsigned long)(&eTravAct)));

(p_UIMagAWOpen1Act=((unsigned long)(&eMagAWOpen1Act)));
(p_UIMagAWOpen2Act=((unsigned long)(&eMagAWOpen2Act)));
(p_UIMagAWOpen3Act=((unsigned long)(&eMagAWOpen3Act)));
...
(p_UIMagRcpInfoIn=((unsigned long)(&tyMagRcpInfoIn)));
(p_UIMagRcpSearch=((unsigned long)(&sMagRcpSearch)));
(p_UIMagRcpCurrRcpWr=((unsigned long)(&tyMagRcpCurrRcpWr)));
...
(p_UISimuMod=((unsigned long)(&bSimuMod)));
(p_UINtWr=((unsigned long)(&eNtWr)));

(p_UIMnlMtrPshrExtSpd=((unsigned long)(&diMnlMtrPshrExtSpd)));
(p_UIMnlMtrPshrExtTorq=((unsigned long)(&diMnlMtrPshrExtTorq)));

(p_UIMnlAWPushOrPullerGoWidth=((unsigned long)(&diMnlAWPushOrPullerGoWidth)));
(p_UIMnlAWPushOrPullerNomSpd=((unsigned long)(&diMnlAWPushOrPullerNomSpd)));
(p_UIMnlAWPushOrPullerTargetPos=((unsigned long)(&diMnlAWPushOrPullerTargetPos)));
(p_UIMnlAWPushOrPullerStepSize=((unsigned long)(&diMnlAWPushOrPullerStepSize)));
(p_UIMnlAWPushOrPullerJogSpd=((unsigned long)(&diMnlAWPushOrPullerJogSpd)));
...
(p_UIMnlLifterBtmGoSlt1Pos=((unsigned long)(&diMnlLifterGoSlt1Pos)));
(p_UIMnlLifterBtmMag1GoSlt=((unsigned long)(&diMnlLifterMag1GoSlt)));
(p_UIMnlLifterBtmMag2GoSlt=((unsigned long)(&diMnlLifterMag2GoSlt)));
(p_UIMnlLifterBtmMag3GoSlt=((unsigned long)(&diMnlLifterMag3GoSlt)));
(p_UIMnlLifterBtmNomSpd=((unsigned long)(&diMnlLifterNomSpd)));
(p_UIMnlLifterBtmTargetPos=((unsigned long)(&diMnlLifterTargetPos)));
(p_UIMnlLifterBtmStepSize=((unsigned long)(&diMnlLifterStepSize)));
(p_UIMnlLifterBtmJogSpd=((unsigned long)(&diMnlLifterJogSpd)));

(p_UIMnlLifter2GoSlt1Pos=((unsigned long)(&diMnlLifterGoSlt1Pos2)));
(p_UIMnlLifter2Mag1GoSlt=((unsigned long)(&diMnlLifterMag1GoSlt2)));
(p_UIMnlLifter2Mag2GoSlt=((unsigned long)(&diMnlLifterMag2GoSlt2)));
(p_UIMnlLifter2Mag3GoSlt=((unsigned long)(&diMnlLifterMag3GoSlt2)));
(p_UIMnlLifter2NomSpd=((unsigned long)(&diMnlLifterNomSpd2)));
(p_UIMnlLifter2TargetPos=((unsigned long)(&diMnlLifterTargetPos2)));
(p_UIMnlLifter2StepSize=((unsigned long)(&diMnlLifterStepSize2)));
(p_UIMnlLifter2JogSpd=((unsigned long)(&diMnlLifterJogSpd2)));

(p_UIMnlTravNomSpd=((unsigned long)(&diMnlTravNomSpd)));
(p_UIMnlTravTargetPos=((unsigned long)(&diMnlTravTargetPos)));
(p_UIMnlTravStepSize=((unsigned long)(&diMnlTravStepSize)));
(p_UIMnlTravJogSpd=((unsigned long)(&diMnlTravJogSpd)));

(p_UIMnlMagAW1GoWidth=((unsigned long)(&diMnlMagAW1GoWidth)));
(p_UIMnlMagAW1NomSpd=((unsigned long)(&diMnlMagAW1NomSpd)));
(p_UIMnlMagAW1TargetPos=((unsigned long)(&diMnlMagAW1TargetPos)));
(p_UIMnlMagAW1StepSize=((unsigned long)(&diMnlMagAW1StepSize)));
(p_UIMnlMagAW1JogSpd=((unsigned long)(&diMnlMagAW1JogSpd)));

(p_UIMnlMagAW2GoWidth=((unsigned long)(&diMnlMagAW2GoWidth)));
(p_UIMnlMagAW2NomSpd=((unsigned long)(&diMnlMagAW2NomSpd)));
(p_UIMnlMagAW2TargetPos=((unsigned long)(&diMnlMagAW2TargetPos)));
(p_UIMnlMagAW2StepSize=((unsigned long)(&diMnlMagAW2StepSize)));
(p_UIMnlMagAW2JogSpd=((unsigned long)(&diMnlMagAW2JogSpd)));

(p_UIMnlMagAW3GoWidth=((unsigned long)(&diMnlMagAW3GoWidth)));
(p_UIMnlMagAW3NomSpd=((unsigned long)(&diMnlMagAW3NomSpd)));
(p_UIMnlMagAW3TargetPos=((unsigned long)(&diMnlMagAW3TargetPos)));
(p_UIMnlMagAW3StepSize=((unsigned long)(&diMnlMagAW3StepSize)));
(p_UIMnlMagAW3JogSpd=((unsigned long)(&diMnlMagAW3JogSpd)));

(p_UIVSMEMAUSAEn=((unsigned long)(&bVSMEMAUSAEn)));
(p_UIVSMEMAUSBEn=((unsigned long)(&bVSMEMAUSBEn)));
(p_UIVSMEMAUBAA=((unsigned long)(&bVSMEMAUBAA)));
(p_UIVSMEMAUBAAStat=((unsigned long)(&bVSMEMAUBAAStat)));
(p_UIVSMEMAUBAB=((unsigned long)(&bVSMEMAUBAB)));
(p_UIVSMEMAUBABStat=((unsigned long)(&bVSMEMAUBABStat)));

(p_UIOvenInfoSetBrdInOvenA=((unsigned long)(&diSetBrdInOvenA)));
(p_UIOvenInfoSetBrdInOvenB=((unsigned long)(&diSetBrdInOvenB)));
...
(p_UINewMag1=((unsigned long)(&bNewMag1)));
(p_UINewMag2=((unsigned long)(&bNewMag2)));
(p_UINewMag3=((unsigned long)(&bNewMag3)));
(p_UIRlsMag1=((unsigned long)(&bRlsMag1)));
(p_UIRlsMag2=((unsigned long)(&bRlsMag2)));
(p_UIRlsMag3=((unsigned long)(&bRlsMag3)));

(p_UIAGVSimulateSig=((unsigned long)(&tyAGVSimulateSig)));
(p_UIAGVSimulateOnline=((unsigned long)(&bAGVSimulateOnline)));
(p_UIAGVSimulationOn=((unsigned long)(&bAGVSimulationOn)));
...
(p_UIQueryWorkOrderInfo=((unsigned long)(&bQueryWorkOrderInfo)));
(p_UISaveHMIConfigure=((unsigned long)(&bSaveHMIConfigure)));
(p_UISaveHMISvyConfig=((unsigned long)(&bSaveHMISvyConfig)));

(p_UITravLifTopBarcode=((unsigned long)(&tyP0201OpsTravLifter.tyQueryBoardInfo.tyStringTopBarcode.sValue)));
(p_UITravLifBottomBarcode=((unsigned long)(&tyP0201OpsTravLifter.tyQueryBoardInfo.tyStringBottomBarcode.sValue)));
(p_UITravLifPCBBarcode=((unsigned long)(&tyP0201OpsTravLifter.tyQueryWorkOrderInfo.tyStringBarcode.sValue)));

(p_UIMagazine1Id=((unsigned long)(&tyP0202OpsMag1.tyQueryWorkOrderInfo.tyStringMagazineId.sValue)));
(p_UIMagazine1PCBBarcode=((unsigned long)(&tyP0202OpsMag1.tyQueryWorkOrderInfo.tyStringBarcode.sValue)));
(p_UIMagazine2Id=((unsigned long)(&tyP0203OpsMag2.tyQueryWorkOrderInfo.tyStringMagazineId.sValue)));
(p_UIMagazine2PCBBarcode=((unsigned long)(&tyP0202OpsMag1.tyQueryWorkOrderInfo.tyStringBarcode.sValue)));
(p_UIMagazine3Id=((unsigned long)(&tyP0204OpsMag3.tyQueryWorkOrderInfo.tyStringMagazineId.sValue)));
(p_UIMagazine3PCBBarcode=((unsigned long)(&tyP0202OpsMag1.tyQueryWorkOrderInfo.tyStringBarcode.sValue)));

(p_UIMagazineSlotId=((unsigned long)(&iSlotId)));
(p_UISkipWorkOrder=((unsigned long)(&bSkipWorkOrder)));
(p_UIReadWorkOrder=((unsigned long)(&bReadWorkOrder)));
(p_UIDeleteWorkOrder=((unsigned long)(&bDeleteWorkOrder)));


(p_UISOTMagErr1=((unsigned long)(&bSOTMagErr1)));
(p_UISOTMagErr2=((unsigned long)(&bSOTMagErr2)));
(p_UISOTMagErr3=((unsigned long)(&bSOTMagErr3)));
(p_UISOTMagErr4=((unsigned long)(&bSOTMagErr4)));
(p_UISOTMagRdy1=((unsigned long)(&bSOTMagRdy1)));
(p_UISOTMagRdy2=((unsigned long)(&bSOTMagRdy2)));
(p_UISOTMagRdy3=((unsigned long)(&bSOTMagRdy3)));
(p_UISOTMagRdy4=((unsigned long)(&bSOTMagRdy4)));
(p_UISOTMagAvail1=((unsigned long)(&bSOTMagAvail1)));
(p_UISOTMagAvail2=((unsigned long)(&bSOTMagAvail2)));
(p_UISOTMagAvail3=((unsigned long)(&bSOTMagAvail3)));
(p_UISOTMagAvail4=((unsigned long)(&bSOTMagAvail4)));
(p_UISOTMagSLarge1=((unsigned long)(&bSOTMagSLarge1)));
(p_UISOTMagSLarge2=((unsigned long)(&bSOTMagSLarge2)));
(p_UISOTMagSLarge3=((unsigned long)(&bSOTMagSLarge3)));
(p_UISOTMagSLarge4=((unsigned long)(&bSOTMagSLarge4)));

(p_UIAIVReqBring1=((unsigned long)(&bAIVReqBring1)));
(p_UIAIVReqBring2=((unsigned long)(&bAIVReqBring2)));
(p_UIAIVReqBring3=((unsigned long)(&bAIVReqBring3)));
(p_UIAIVReqBring4=((unsigned long)(&bAIVReqBring4)));
(p_UIAIVReqGet1=((unsigned long)(&bAIVReqGet1)));
(p_UIAIVReqGet2=((unsigned long)(&bAIVReqGet2)));
(p_UIAIVReqGet3=((unsigned long)(&bAIVReqGet3)));
(p_UIAIVReqGet4=((unsigned long)(&bAIVReqGet4)));


(p_UIMagAWOpenLimByp1=((unsigned long)(&bMagAWOpenLimByp1)));
(p_UIMagAWOpenLimByp2=((unsigned long)(&bMagAWOpenLimByp2)));
(p_UIMagAWOpenLimByp3=((unsigned long)(&bMagAWOpenLimByp3)));
(p_UIMagAWOpenLimByp4=((unsigned long)(&bMagAWOpenLimByp4)));
(p_UIMagAWSmallLimSen1=((unsigned long)(&bSmallMagLimSen1)));
(p_UIMagAWSmallLimSen2=((unsigned long)(&bSmallMagLimSen2)));
(p_UIMagAWSmallLimSen3=((unsigned long)(&bSmallMagLimSen3)));
(p_UIMagAWSmallLimSen4=((unsigned long)(&bSmallMagLimSen4)));

(p_UISOTSimulationSig1=((unsigned long)(&tySOTSimulateSig1)));
(p_UISOTSimulationSig2=((unsigned long)(&tySOTSimulateSig2)));
(p_UISOTSimulationSig3=((unsigned long)(&tySOTSimulateSig3)));


(p_UIUnloadMag=((unsigned long)(&bUnloadMag)));
(p_UIOpsMnlUnloadMag=((unsigned long)(&bOpsMnlUnloadMag)));
(p_UIOpsMnlUnloadMag2=((unsigned long)(&bOpsMnlUnloadMag2)));


(p_UIInMagConvAct=((unsigned long)(&eInMagConvAct)));
(p_UIOutMagConvAct=((unsigned long)(&eOutMagConvAct)));
(p_UIInMagConv2Act=((unsigned long)(&eInMagConv2Act)));
(p_UIOutMagConv2Act=((unsigned long)(&eOutMagConv2Act)));
(p_UILifterMagConvAct=((unsigned long)(&eLifterMagConvAct)));
(p_UILifterMagConv2Act=((unsigned long)(&eLifterMagConv2Act)));
(p_UIStopper1Act=((unsigned long)(&eStopper1Act)));
(p_UIStopper2Act=((unsigned long)(&eStopper2Act)));
(p_UIStopper3Act=((unsigned long)(&eStopper3Act)));
(p_UIStopper4Act=((unsigned long)(&eStopper4Act)));
(p_UIStopper5Act=((unsigned long)(&eStopper5Act)));
(p_UIStopper1Act2=((unsigned long)(&eStopper1Act2)));
(p_UIStopper2Act2=((unsigned long)(&eStopper2Act2)));
(p_UIStopper3Act2=((unsigned long)(&eStopper3Act2)));
(p_UIStopper4Act2=((unsigned long)(&eStopper4Act2)));
(p_UIStopper5Act2=((unsigned long)(&eStopper5Act2)));

(p_UIMnlPPNomSpd=((unsigned long)(&diMnlPPNomSpd)));
(p_UIMnlPPTargetPos=((unsigned long)(&diMnlPPTargetPos)));
(p_UIMnlPPStepSize=((unsigned long)(&diMnlPPStepSize)));
(p_UIMnlPPJogSpd=((unsigned long)(&diMnlPPJogSpd)));

(p_UISafetyCurtainReset=((unsigned long)(&bSafetyCurtainReset)));
(p_UIMnlBypCurtainPBLED=((unsigned long)(&bBypCurtainPBLED)));
(p_UIMnlBypCurtainSen=((unsigned long)(&bBypCurtainSen)));


(p_SelProdRcpStep=((unsigned long)(&usiSelProdRcpStep)));


(p_UIHcomModchanged=((unsigned long)(&usiHComModChaged)));


(p_UIStartScanSig=((unsigned long)(&bStartScanSig)));
(p_UIMag1TransOut=((unsigned long)(&bPCBExitMag1)));
(p_UIMag2TransOut=((unsigned long)(&bPCBExitMag2)));
(p_UIMag3TransOut=((unsigned long)(&bPCBExitMag3)));


(p_UISetHMIIPAddr=((unsigned long)(&sSetHMIIPAddr)));
(p_UIUpdtHMIIPAddr=((unsigned long)(&bUpdtHMIIPAddr)));
}}
#line 300 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/UI/UI/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/UI/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/UI/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/UI/UI/Init.st\\\"\\n\"");
__asm__(".previous");
