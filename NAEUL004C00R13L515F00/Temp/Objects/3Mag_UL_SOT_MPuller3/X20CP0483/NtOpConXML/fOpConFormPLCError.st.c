...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConFormPLCErrorst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConFormPLCError.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConFormPLCError.st"
signed short fOpConFormPLCError(struct tyXMLTableDat pa_tyXMLTable[64], struct DTStructure(* tyDTStructure), struct tyEventType(* tyEventParam), struct tyLocationParam(* tyLocationParam), struct tyOpConPLCError(* tyParam)){signed short __AS__fOpConFormPLCError=0;signed short iTotalIdxWrite=0;plcstring sTimestamp[24]="";{

__AS__MEMSET(((unsigned long)(pa_tyXMLTable)),0,16640);
(iTotalIdxWrite=0);
...
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"ST"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)"plcError"; for(zzIndex=0; zzIndex<8l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));
...
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AT"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)"errorNo"; for(zzIndex=0; zzIndex<7l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
uint2str(((*(tyParam)).tyData.uiErrorNo),pa_tyXMLTable[iTotalIdxWrite].sValue,255);
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AT"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)"errorText"; for(zzIndex=0; zzIndex<9l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)((*(tyParam)).tyData.sErrorText); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AT"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)"errorType"; for(zzIndex=0; zzIndex<9l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
usint2str(((*(tyParam)).tyData.usiErrorType),pa_tyXMLTable[iTotalIdxWrite].sValue,255);
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AT"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)"errorState"; for(zzIndex=0; zzIndex<10l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
usint2str(((*(tyParam)).tyData.usiErrorState),pa_tyXMLTable[iTotalIdxWrite].sValue,255);
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AT"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)"operationMode"; for(zzIndex=0; zzIndex<13l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
usint2str(((*(tyParam)).tyData.usiOperationMode),pa_tyXMLTable[iTotalIdxWrite].sValue,255);
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AT"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)"modeOn"; for(zzIndex=0; zzIndex<6l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
bool2str(((*(tyParam)).tyData.bModeOn),pa_tyXMLTable[iTotalIdxWrite].sValue,255);
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AT"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)"chainNo"; for(zzIndex=0; zzIndex<7l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));

{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
int2str(((*(tyParam)).tyData.iChainNo),pa_tyXMLTable[iTotalIdxWrite].sValue,255);
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));
...
}return __AS__fOpConFormPLCError;}
#line 417 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConFormPLCError.nodebug"

void __AS__ImplInitfOpConFormPLCError_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConFormPLCError.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConFormPLCError.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConFormPLCError.st\\\"\\n\"");
