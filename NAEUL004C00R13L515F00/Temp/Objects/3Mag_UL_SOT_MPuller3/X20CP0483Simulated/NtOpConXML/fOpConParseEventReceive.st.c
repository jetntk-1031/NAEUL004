...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConParseEventReceivest.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConParseEventReceive.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConParseEventReceive.st"
plcbit fOpConParseEventReceive(struct tyEventType(* p_tyEventTypeReceive), struct tyXMLTableDat(* tyXMLTableCurr), struct tyXMLTableDat(* tyXMLTableNxt), plcstring sCurrValueLowerCase[255]){plcbit __AS__fOpConParseEventReceive=0;{

(__AS__fOpConParseEventReceive=1);


if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"eventid")==0)))){

((*(p_tyEventTypeReceive)).tyAvl.bEventId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyEventTypeReceive)).tyData.uiEventId=str2uint(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"eventname")==0)))){
((*(p_tyEventTypeReceive)).tyAvl.bEventName=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyEventTypeReceive)).tyData.sEventName); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<30l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"contenttype")==0)))){
((*(p_tyEventTypeReceive)).tyAvl.bContentType=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyEventTypeReceive)).tyData.usiContentType=str2usint(((*(tyXMLTableNxt)).sValue)));
}
}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"eventSwitch")==0)))){
((*(p_tyEventTypeReceive)).tyAvl.bEventSwitch=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyEventTypeReceive)).tyData.siEventSwitch=str2sint(((*(tyXMLTableNxt)).sValue)));
}
}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"version")==0)))){
((*(p_tyEventTypeReceive)).tyAvl.bVersion=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyEventTypeReceive)).tyData.sVersion); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<5l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}
}
...
}imp1_else5_0:imp1_end5_0:imp1_else0_4:imp1_end0_0:;return __AS__fOpConParseEventReceive;}
#line 88 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConParseEventReceive.nodebug"

void __AS__ImplInitfOpConParseEventReceive_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConParseEventReceive.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConParseEventReceive.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConParseEventReceive.st\\\"\\n\"");
