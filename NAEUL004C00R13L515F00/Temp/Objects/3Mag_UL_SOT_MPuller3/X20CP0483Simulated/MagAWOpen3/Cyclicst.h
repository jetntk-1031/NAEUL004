...
_BUR_LOCAL plcbit(* p_bLinkNtParamProjMagAWPrep);
_BUR_LOCAL eULMag(* p_bLinkNtParamProjMag);
_BUR_LOCAL plcbit(* p_bLinkDIMagPresentSen);
_BUR_LOCAL eMagAWAction(* p_eAct);
...
_BUR_LOCAL signed long(* p_diEngageVelInUMPS);
...
_BUR_LOCAL plcbit(* p_bGearEngaged);
...
_BUR_LOCAL signed long diEngageVelInUMPS;
...
_BUR_LOCAL plcbit bGearEngaged;
...
_BUR_LOCAL struct fbMotionCANJog fbEngage;
...
_BUR_LOCAL struct fbMotionCANFullPwrOn fbFullPwrOn;
...
_BUR_LOCAL struct TON fbEngageTO;
...
_GLOBAL unsigned long p_StartupMagAW3Act;
