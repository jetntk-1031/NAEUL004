...
_BUR_LOCAL signed long(* p_diLinkProdSelWidth);
_BUR_LOCAL signed long(* p_diLinkPshrOffset);
_BUR_LOCAL signed long(* p_diLinkMnlGoWidth);
...
_GLOBAL unsigned long p_StartupAWPushPulAct;
