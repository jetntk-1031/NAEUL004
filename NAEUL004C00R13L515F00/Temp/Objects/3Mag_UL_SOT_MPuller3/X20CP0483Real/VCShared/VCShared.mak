...
TXTGRP_SHARED_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T1000_Alarm.txtgrp \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T1190_BufferText.txtgrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T2000_LeaderFollowerText.txtgrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T2010_MotionText.txtgrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T2020_OvenInfoText.txtgrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T2030_SMEMAText.txtgrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T3010_IOMonitor.txtgrp \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T2050_RS232.txtgrp \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T1090_MagModel.txtgrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T3000_AGV.txtgrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T1010_TextRecovery.txtgrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/MainMenu.txtgrp 
...
$(AS_CPU_PATH)/VCShared/txtgrp.T1190_BufferText.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T1190_BufferText.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4721 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.T2000_LeaderFollowerText.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T2000_LeaderFollowerText.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4721 -sfas
...
$(AS_CPU_PATH)/VCShared/txtgrp.T2020_OvenInfoText.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T2020_OvenInfoText.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4721 -sfas
...
$(AS_CPU_PATH)/VCShared/txtgrp.T3010_IOMonitor.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T3010_IOMonitor.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4721 -sfas
...
$(AS_CPU_PATH)/VCShared/txtgrp.T2050_RS232.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T2050_RS232.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4721 -sfas
...
$(AS_CPU_PATH)/VCShared/txtgrp.T1090_MagModel.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T1090_MagModel.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4721 -sfas


$(AS_CPU_PATH)/VCShared/txtgrp.T3000_AGV.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/T3000_AGV.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4721 -sfas
...
$(AS_CPU_PATH)/VCShared/txtgrp.MainMenu.vco: $(AS_PROJECT_PATH)/Logical/VCShared/TextGroups/MainMenu.txtgrp $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4721 -sfas
