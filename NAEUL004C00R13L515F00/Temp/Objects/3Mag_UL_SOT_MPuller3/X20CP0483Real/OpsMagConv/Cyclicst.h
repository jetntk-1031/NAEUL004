...
_BUR_LOCAL plcbit(* p_bMag1OrientationChkSen1);
_BUR_LOCAL plcbit(* p_bMagHeightDetSen1);
...
_BUR_LOCAL plcbit bCAB703;
_BUR_LOCAL plcbit bFIXMag;
_BUR_LOCAL plcbit bMagManEx;
_BUR_LOCAL plcbit bMagAutoEx;
_BUR_LOCAL plcbit bAGVComm1Rdy;
_BUR_LOCAL plcbit bTLMuteBuzzer;
_BUR_LOCAL plcbit bMagFullInfo;
_BUR_LOCAL plcbit bStepOpsMagAWDone;
_BUR_LOCAL plcbit bStepOpsPitchUpdated;
_BUR_LOCAL eOpConMsgType tyOpConMsgReq;
_BUR_LOCAL plcbit bPartMissingStarted;
...
_GLOBAL plcstring g_sOpsMagConvULProgNm[16];
...
_GLOBAL unsigned long p_USSMEMA1Stat;
_GLOBAL unsigned long p_USSMEMA1Status;
_GLOBAL unsigned long p_USSMEMA1Transporting;
_GLOBAL unsigned long p_USSMEMA1ConvStart;
_GLOBAL unsigned long p_USSMEMA1ConvStop;
...
_GLOBAL unsigned long p_USSOT1USLargeMagRdy;
