...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/OpsMagConv/Cyclicst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.st"
...
#line 28 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Act_InitGlobal.st"
...
(p_bLinkDIMagEntrySen=p_DIMagConvEntSen1);
...
(p_bMag1OrientationChkSen1=p_DIMag1OrientChkSen1);


(p_bMagHeightDetSen1=p_DIHighMagDetSen1);
...
(p_bEn=p_NtParamProjMag1ConvPrep);
(p_bRun=p_OpsRun);
(p_bStop=p_OpsStop);
(p_bStep=p_OpsStep);

(p_sProgNm=p_NtParamOpsMagConvUL1ProgNm);
...
(p_bNewMag=p_UINewMag1);
(p_bRlsMag=p_UIRlsMag1);
...
(p_eBufferStat=p_Buffer1Stat);
(p_eBufferStatus=p_Buffer1Status);

(p_bBufferMagRemoved=p_Buffer1MagRemoved);
(p_bBufferMagRemoved1=p_Buffer1MagRemoved);
(p_bBufferMagRemoved2=p_Buffer2MagRemoved);
(p_bBufferMagRemoved3=p_Buffer3MagRemoved);

(p_eMagConv2ClpStat=p_MagConv2Clp1Stat);
(p_eMagConv2ClpStatus=p_MagConv2Clp1Status);
(p_bMagConv2ClpHvMag=p_MagConv2Clp1HvMag);

(p_eUSSMEMAStat=p_USSMEMA1Stat);
(p_eUSSMEMAStatus=p_USSMEMA1Status);
(p_bUSSMEMATransporting=p_USSMEMA1Transporting);
(p_bUSSMEMAConvStart=p_USSMEMA1ConvStart);
(p_bUSSMEMAConvStop=p_USSMEMA1ConvStop);
...
(p_eSelClampCtrlStat=p_PneuNoSenSelClamp1Stat);
(p_eSelClampCtrlStatus=p_PneuNoSenSelClamp1Status);

(p_bOutShutterExtended=p_Pneu2SenOutShutterExtended);

(p_bDIMagConvHeightSen=p_DIMagConvHeightSen1);
(p_bDIMagConvSelUnclampRS=p_DIMag1SelUnclampRS);
(p_bDIMagConvCAB717Sen=p_DIMagConvCAB717MagSen1);
(p_bDIMagConvSmallSen=p_DIMagConvSmallMagSen1);
(p_bDIMagConvLargeSen=p_DIMagConvLargeMagSen1);
(p_bDIOutShutterClosedRS=p_DIOutShutterCloseRS);

(p_eNtParamProjMagBuffferActLoad=p_NtParamProjMagBuffferActLoad);

(p_eSafetyBarStat=p_Pneu2SMag1SafetyBarStat);
(p_eSafetyBarStatus=p_Pneu2SMag1SafetyBarStatus);
(p_bSafetyBarExtended=p_Pneu2SMag1SafetyBarExtended);
(p_bSafetyBarRetracted=p_Pneu2SMag1SafetyBarRetracted);

(p_eMagAWEngageStat=p_Pneu2SMag1AWEngageStat);
(p_eMagAWEngageStatus=p_Pneu2SMag1AWEngageStatus);

(p_eMagAWStat=p_MagAWOpen1Stat);
(p_eMagAWStatus=p_MagAWOpen1Status);
(p_bMagAWEngaging=p_MagAWOpen1Engaging);
(p_bMagAWErr=p_MagAWOpen1AxisErr);
(p_bMagAWOpenLimit=p_MagAWOpen1OpenSen);
(p_bMagAWCloseLimit=p_MagAWOpen1CloseSen);
...
(p_bUSSOTUSLargeMagRdy=p_USSOT1USLargeMagRdy);
...
(p_bDISOTRcv=p_DISOT1Receive);
(p_bDISOTAGVReady=p_DISOT1Ready);
...
(p_bOpsTravLifErrCmdUnclmp=p_OpsTravLifWChkErrCmdUnclmp1);
...
(p_bMagPropDiffBlk=p_AutoRcpbMag1PropDiffBlk);
(p_bChgMagWidth=p_AutoRcpbMag1WidthChg);
(p_bChgMagSlot=p_AutoRcpbMag1SlotChg);

(p_bMagOrientChkSenPrep=p_NtParamProjMagOrientChkSenPrep);
(p_bDIMagFixedClampSen=p_DIMag1FixedClampSen);

(p_eCustomerReq=p_NtParamCustomerReq);

(p_tyResponseFromMES=p_TagFromMesMagConv1);
(p_bOpsTravLifAllwExitMag=p_OpsTravLifAllwExitMag1);
...
(p_dtOpsMagConvUL3AcptTm=p_OpsMagConvUL3AcptTm);
(p_iOpsMagConvUL2MESAcptCond=p_OpsMagConvUL2MESAcptCond);
(p_iOpsMagConvUL3MESAcptCond=p_OpsMagConvUL3MESAcptCond);
(p_bOpsMagConvUL2MagExitedWait=p_OpsMagConvUL2MagExitedWait);
(p_bOpsMagConvUL3MagExitedWait=p_OpsMagConvUL3MagExitedWait);
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Act_LinkEn.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Act_Link.st"
static void __AS__Action__Act_Link(void){
{

((*(p_bMagClampRS1))=((((*(p_bLinkFixedMagClampRS1)))&((*(p_bLinkRmtMagClampRS1))))|bNewMagVerified));
((*(p_bMagClampRS2))=((((*(p_bLinkFixedMagClampRS2)))&((*(p_bLinkRmtMagClampRS2))))|((*(p_bLinkNewMagVerified2)))));
((*(p_bMagClampRS3))=((((*(p_bLinkFixedMagClampRS3)))&((*(p_bLinkRmtMagClampRS3))))|((*(p_bLinkNewMagVerified3)))));
...
(fbMagAutoDetTm.IN=(((*(p_bLinkDIMagEntrySen)))|((*(p_bLinkDIMagPresentSen1)))));;(fbMagAutoDetTm.PT=(plctime)((*(p_bLinkMcParamMagAutoDetTm))));;TON(&fbMagAutoDetTm);
...
if(((((unsigned long)(unsigned char)((*(p_bLinkMagRcpCurrRcpMagModel)))==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bDIMagConvHeightSen)))==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(p_bDIMagConvSelUnclampRS)))==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bDIMagConvCAB717Sen)))==(unsigned long)(unsigned char)0))&((*(p_bDIMagConvSmallSen)))&(((((*(p_bMagAWCloseLimit))^1))&(((*(p_bMagAWOpenLimit))^1)))|(((unsigned long)(unsigned char)((*(p_tyBufferStat1)).bBffrMty)==(unsigned long)(unsigned char)0))))){
(bNewMagVerified=1);
...
else if(((((unsigned long)(unsigned char)((*(p_bLinkMagRcpCurrRcpMagModel)))==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(p_bDIMagConvHeightSen)))==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bDIMagConvSelUnclampRS)))==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bDIMagConvCAB717Sen)))==(unsigned long)(unsigned char)0))&((*(p_bDIMagConvSmallSen)))&(((((*(p_bMagAWCloseLimit))^1))&(((*(p_bMagAWOpenLimit))^1)))|(((unsigned long)(unsigned char)((*(p_tyBufferStat1)).bBffrMty)==(unsigned long)(unsigned char)0))))){
(bNewMagVerified=1);
...
if((((unsigned long)(unsigned char)((*(p_bLinkMagRcpCurrRcpMagModel)))==(unsigned long)(unsigned char)3))){
(bCAB703=1);
(bFIXMag=0);
}else if((((unsigned long)(unsigned char)((*(p_bLinkMagRcpCurrRcpMagModel)))==(unsigned long)(unsigned char)4))){
(bCAB703=0);
(bFIXMag=1);
}


(bAIVInPos=(((*(p_tyAGVToDTMag)).bVEHInPos1)|((*(p_bDISOTRcv)))));
...
if(bAutoRcpEn){
((*(p_bUSAllow))=((((*(p_bMagPropDiffBlk))^1))&((((*(p_bNtParamAutoRcpF1ArbitraryType))^1))|((__AS__STRING_CMP(((*(p_sProdRcpCurrRcp1Name))),((*(p_sProdRcpCurrRcp2Name))))==0)))));
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Act_RstErr.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Act_InitLocal.st"
...
(p_dtOpsMagConvUL1AcptTm=((unsigned long)(&dtMagConvAcptTm)));
(p_iOpsMagConvUL1MESAcptCond=((unsigned long)(&iMagMESAcptCond)));
}}
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Act_Initial.st"
static void __AS__Action__Act_Initial(void){
{

}}
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Act_Background.st"
...
if(((((unsigned long)(unsigned char)((*(p_bBufferMagPresent1)))==(unsigned long)(unsigned char)0))|((~((*(p_bMcParamMagAWDis)))&Edge0000300004&1?((Edge0000300004=((*(p_bMcParamMagAWDis)))&1),1):((Edge0000300004=((*(p_bMcParamMagAWDis)))&1),0))&((*(p_tyBufferStat1)).bBffrMty)))){
(bMagAWDone=0);

}


if(((~((*(p_bMcParamMagAWDis)))&Edge0000300005&1?((Edge0000300005=((*(p_bMcParamMagAWDis)))&1),1):((Edge0000300005=((*(p_bMcParamMagAWDis)))&1),0))&(((unsigned long)(unsigned char)((*(p_tyBufferStat1)).bBffrMty)==(unsigned long)(unsigned char)0)))){
(bMagExitedWait=1);
(bNewMagVerified=0);
}
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Act_Alarm.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)g_sOpsMagConvULProgNm; plcstring* zzRValue=(plcstring*)((*(p_sProgNm))); for(zzIndex=0; zzIndex<15l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Act_AlarmInfo1.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Sequence/Act_OpsInitial.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Sequence/Act_OpsRun.st"
...
if((((*(p_bMag1OrientationChkSen1)))&((*(p_bMagHeightDetSen1))))){
(eOpsStep=eGotoOpsStep);
}else{
(eMagConv2ClpAct=27);
...
if((((*(p_bMag1OrientationChkSen1)))&(((*(p_bMagHeightDetSen1))^1)))){
(eOpsStep=eGotoOpsStep);
}else{
(eMagConv2ClpAct=27);
...
(a_bMagAllwMagPresent[1-1]=(((*(p_bBufferMagPresent1)))&(bMagExitedWait^1)));
(a_bMagAllwMagPresent[2-1]=(((*(p_bBufferMagPresent2)))&(((*(p_bOpsMagConvUL2MagExitedWait))^1))));
(a_bMagAllwMagPresent[3-1]=(((*(p_bBufferMagPresent3)))&(((*(p_bOpsMagConvUL3MagExitedWait))^1))));
...
}else if((((((*(p_bAllwChgWidth)))|((*(p_bAllwChgSlot))))&(((*(p_bMcParamAutoRcpDis))^1)))|(((unsigned long)(unsigned char)((*(p_bUSAllow)))==(unsigned long)(unsigned char)0)))){
(bMagBffrAvl=0);
(eUSSMEMAAct=0);
(eGotoOpsStep=21);
...
(fbEntSenOff.IN=((((unsigned long)(unsigned char)((*(p_bLocalMagEntrySen)))==(unsigned long)(unsigned char)0))&(((((*(p_bLocalBufferMagPresent)))|((*(p_bMag1OrientationChkSen1))))&((*(p_bProjLifTravMnlLoad))))^1)));;TON(&fbEntSenOff);
...
(bStepMagBffrLoad=(((signed long)eOpsStep>(signed long)3)));

(bAGVComm1Rdy=(((((signed long)eOpsStep==(signed long)3))|(((signed long)eOpsStep==(signed long)31))|(((signed long)eOpsStep==(signed long)35))|(((signed long)eOpsStep==(signed long)8))|(((signed long)eOpsStep==(signed long)32)))&((*(p_bAGVMagMcRunRdy)))));
...
(bStepPLCGrab=(((*(p_tyLocalBufferStat)).bBffrMty)&(((*(p_bMagPresentSen)))&~Edge0001300003&1?((Edge0001300003=((*(p_bMagPresentSen)))&1),1):((Edge0001300003=((*(p_bMagPresentSen)))&1),0))));

}}
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Sequence/Act_OpsInfo.st"
...
(a_bMagAllwMagPresent[1-1]=(((unsigned long)(unsigned char)((*(p_bBufferMagRemoved1)))==(unsigned long)(unsigned char)0)));
(a_bMagAllwMagPresent[2-1]=(((unsigned long)(unsigned char)((*(p_bBufferMagRemoved2)))==(unsigned long)(unsigned char)0)));
(a_bMagAllwMagPresent[3-1]=(((unsigned long)(unsigned char)((*(p_bBufferMagRemoved3)))==(unsigned long)(unsigned char)0)));
...
if(((((signed long)eOpsStep>(signed long)7))|(((signed long)eOpsStep==(signed long)3)))){
(udiStatus1=10000);
}
}
...
for((udi1=1);udi1<=3;udi1+=1){
if(((((unsigned long)(unsigned char)((*(pa_bMagDis))[udi1-1])==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)a_bMagAllwMagPresent[udi1-1]==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)a_tyMagAllwBffrStat[udi1-1].bBffrFull==(unsigned long)(unsigned char)1)))){
if(((((signed long)((*(p_eCustomerReq)))==(signed long)0))|((((unsigned long)udi<(unsigned long)4))&(((signed long)((*(p_eCustomerReq)))==(signed long)1))))){
(udiStatus1=(10001+(udi1-1)));
(bTLMuteBuzzer=0);
goto imp10_endfor7_0;
}else if((((signed long)((*(p_eCustomerReq)))==(signed long)1))){
(bTLMuteBuzzer=1);
(udiStatus1=(10001+(udi1-1)));
for((udi2=1);udi2<=3;udi2+=1){
if((((unsigned long)udi2!=(unsigned long)udi1))){
if(((((unsigned long)(unsigned char)((*(pa_bMagDis))[udi2-1])==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)a_bMagAllwMagPresent[udi2-1]==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)a_tyMagAllwBffrStat[udi2-1].bBffrFull==(unsigned long)(unsigned char)1)))){
(udiStatus1=(10001+(udi2-1)));
goto imp10_endfor10_0;
}
}
}imp10_endfor10_0:;
}
...
if(((((unsigned long)udiStatus1<=(unsigned long)10004))&(((unsigned long)udiStatus1!=(unsigned long)10000)))){
(bMagFullInfo=1);
}else{
(bMagFullInfo=0);
}
...
if((fbVerifyWarningDelay.Q&(((unsigned long)(unsigned char)((*(p_tyBufferStat1)).bBffrFull)==(unsigned long)(unsigned char)0)))){
if(((((*(p_bMagAWCloseLimit)))|((*(p_bMagAWOpenLimit))))&((*(p_tyBufferStat1)).bBffrMty))){
...
if((((unsigned long)udiStatus1==(unsigned long)10000))){
(fbIdleTm.IN=1);;TON(&fbIdleTm);
if(fbIdleTm.Q){
(fbIdleTm.IN=0);;TON(&fbIdleTm);
(bPartMissingStarted=1);
(tyOpConMsgReq=6);
}
}else if((bPartMissingStarted&(((*(p_bMagPresentSen1)))|((*(p_bMagPresentSen2)))|((*(p_bMagPresentSen3)))))){
(bPartMissingStarted=0);
(tyOpConMsgReq=7);
}else{
(fbIdleTm.IN=0);;TON(&fbIdleTm);
}
...
}imp10_else38_2:imp10_end38_0:imp10_else37_0:imp10_end37_0:;}
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Sequence/Act_OpsRst.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Sequence/Act_LogStep.st"
...
__asm__(".ascii \"iecfile \\\"Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/InputRef_Link.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/InputRef.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Local.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/OpsMagConv/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/OpsMagConv/Cyclic.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Cyclic.st\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/OpsMagConv/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");
