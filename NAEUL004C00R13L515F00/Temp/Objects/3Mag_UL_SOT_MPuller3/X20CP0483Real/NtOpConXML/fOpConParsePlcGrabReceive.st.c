...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConParsePlcGrabReceivest.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConParsePlcGrabReceive.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConParsePlcGrabReceive.st"
plcbit fOpConParsePlcGrabReceive(struct tyOpConPlcGrabReceive(* p_tyPlcGrabReceive), struct tyXMLTableDat(* tyXMLTableCurr), struct tyXMLTableDat(* tyXMLTableNxt), plcstring sCurrValueLowerCase[255]){plcbit __AS__fOpConParsePlcGrabReceive=0;{

(__AS__fOpConParsePlcGrabReceive=1);

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"returncode")==0)))){

((*(p_tyPlcGrabReceive)).tyAvl.bReturnCode=1);
...
((*(p_tyPlcGrabReceive)).tyData.iReturnCode=str2int(((*(tyXMLTableNxt)).sValue)));
}
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"level")==0)))){

((*(p_tyPlcGrabReceive)).tyAvl.bTypeVar=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyPlcGrabReceive)).tyData.sLevel); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<20l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"text")==0)))){
((*(p_tyPlcGrabReceive)).tyAvl.bTraceTxt=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyPlcGrabReceive)).tyData.sTraceTxt); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}

}imp1_else4_0:imp1_end4_0:imp1_else0_2:imp1_end0_0:;return __AS__fOpConParsePlcGrabReceive;}
#line 36 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConParsePlcGrabReceive.nodebug"

void __AS__ImplInitfOpConParsePlcGrabReceive_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConParsePlcGrabReceive.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConParsePlcGrabReceive.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConParsePlcGrabReceive.st\\\"\\n\"");
