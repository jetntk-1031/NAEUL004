...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConFormPLCGrabst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConFormPLCGrab.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConFormPLCGrab.st"
signed short fOpConFormPLCGrab(struct tyXMLTableDat pa_tyXMLTable[52], struct DTStructure(* tyDTStructure), struct tyEventType(* tyEventParam), struct tyOpConPLCGrab(* tyParam)){signed short __AS__fOpConFormPLCGrab=0;signed long zzIndex00001;signed long zzIndex00000;signed short iTotalIdxWrite=0;plcstring sTimestamp[24]="";{
...
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)((*(tyParam)).tyData.sMagazineNm[1]); for(zzIndex=0; zzIndex<30l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));
...
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)((*(tyParam)).tyData.sValue[1]); for(zzIndex=0; zzIndex<10l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));
...
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)((*(tyParam)).tyData.sMagazineNm[2]); for(zzIndex=0; zzIndex<30l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));
...
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)((*(tyParam)).tyData.sValue[2]); for(zzIndex=0; zzIndex<10l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));
...
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)((*(tyParam)).tyData.sMagazineNm[3]); for(zzIndex=0; zzIndex<30l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));
...
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sTitle; plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)pa_tyXMLTable[iTotalIdxWrite].sValue; plcstring* zzRValue=(plcstring*)((*(tyParam)).tyData.sValue[3]); for(zzIndex=0; zzIndex<10l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(pa_tyXMLTable[iTotalIdxWrite].uiSize=LEN(pa_tyXMLTable[iTotalIdxWrite].sValue));
(iTotalIdxWrite=(iTotalIdxWrite+1));
...
}return __AS__fOpConFormPLCGrab;}
#line 345 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConFormPLCGrab.nodebug"

void __AS__ImplInitfOpConFormPLCGrab_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConFormPLCGrab.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/NtOpConXML/fOpConFormPLCGrab.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/NtLibraries/NtOpConXML/fOpConFormPLCGrab.st\\\"\\n\"");
