...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/AutoRcp/Cyclicst.h"
...
(p_bNtParamProjMagAWPrep=p_NtParamProjMagAWPrep);
...
{int zzIndex; unsigned char* zzLValue=(unsigned char*)a_tyMagPropsWr; unsigned char* zzRValue=(unsigned char*)a_tyMagProps; for(zzIndex=0; zzIndex<2112l; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex];};
}break;}
((*(p_eAct))=5);
}
...
(a_bMagChangOverBlk[ii-1]=0);
(a_bAllwChangeWidth[ii-1]=((a_bMagAWWidthDiff[ii-1]|a_bForceChgWidthIfSameRcp[ii-1])&a_tyBffrStat[ii-1].bBffrMty&((*(p_bNtParamProjMagAWPrep)))));
...
{
if((((*(p_bNtParamF1ArbitraryType))^1))){
...
if(((((signed long)memcmp(((unsigned long)(&tyCurrZ1Rcp)),((unsigned long)(&tyCurrReqRcp)),1084)!=(signed long)0))&(((tyCurrReqRcp.rWidth!=0))|((*(p_bNtParamF1ArbitraryType)))))){
if(((*(p_bZ1AccNewRcpCondition)))){
(tyCurrZ1Rcp=*(struct tyBoardProperty*)&tyCurrReqRcp);
(bOverWriteTravLifProperties=1);
(usiChg2=(usiChg2+1));
...
if(((*(p_bZ2AccNewRcpCondition)))){
if((((unsigned long)(unsigned char)a_bBufferMagPresent[ii-1]==(unsigned long)(unsigned char)0))){
__AS__MEMSET((((unsigned long)(&a_tyMagProps[1-1]))+((ii-1)*528)),0,528);
(a_bMagChangOverBlk[ii-1]=0);
}else{
(p_tyMagCmpRcp=(((unsigned long)(&a_tyMagProps[1-1]))+((ii-1)*528)));
(a_bCheckDifferent[ii-1]=((((signed long)memcmp(((unsigned long)(&((*(p_tyMagCmpRcp))))),((unsigned long)(&tyCurrReqMagRcp)),528)!=(signed long)0))&((((signed long)tyCurrReqMagRcp.diWidth!=(signed long)0))|((*(p_bNtParamF1ArbitraryType))))));
if(a_bCheckDifferent[ii-1]){
(a_bAllwChangeWidth[ii-1]=0);
if(a_tyBffrStat[ii-1].bBffrMty){
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/AutoRcp/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/AutoRcp/Cyclic.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AutoRcp/AutoRcp/Cyclic.st\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/3Mag_UL_SOT_MPuller3/X20CP0483/AutoRcp/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");
