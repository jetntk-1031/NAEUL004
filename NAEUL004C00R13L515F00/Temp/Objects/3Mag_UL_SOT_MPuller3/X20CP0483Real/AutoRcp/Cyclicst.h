...
_GLOBAL unsigned long p_StartupAutoRcpsAct;
_GLOBAL plcstring g_sAutoRcpProgNm[16];
...
_GLOBAL unsigned long p_MagAWOpen1WidthPosDiff;
_GLOBAL unsigned long p_MagAWOpen2WidthPosDiff;
_GLOBAL unsigned long p_MagAWOpen3WidthPosDiff;
