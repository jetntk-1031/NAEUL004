...
_BUR_LOCAL plcbit(* p_bLinkDIConvClrSen);
_BUR_LOCAL plcbit(* p_bLinkDIPusherRetRS);
_BUR_LOCAL plcbit(* p_bConvPusherReachedRetSlw);
_BUR_LOCAL eLifterAction(* p_eLinkLifter2Stat);
_BUR_LOCAL eFBStatus(* p_eLinkLifter2Status);
_BUR_LOCAL eLifterAction(* p_eLinkLifterBtmStat);
_BUR_LOCAL eFBStatus(* p_eLinkLifterBtmStatus);
_BUR_LOCAL ePneuAction(* p_eAct);
_BUR_LOCAL unsigned long(* p_udiRstErr);
_BUR_LOCAL plcbit(* p_bPrep);
_BUR_LOCAL plcbit(* p_bEn);
_BUR_LOCAL plcbit(* p_bDis);
_BUR_LOCAL plcbit(* p_bUISimu);
...
_GLOBAL unsigned long p_Simu1OutShutterAct2;
