...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/OpsMagConv/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Init.st"
...
(p_OpsMagConvUL1AlmData=((unsigned long)(&tyAlmData)));
(p_OpsMagConvUL1AlmData1=((unsigned long)(&tyAlmData1)));


(p_OpsMagConvUL1StepTxt=((unsigned long)(&sStepTxt)));
(p_OpsMagConvUL1Paused=((unsigned long)(&bPaused)));

(p_OpsMagConvUL1BufferAct=((unsigned long)(&eBufferAct)));
(p_OpsMagConvUL1MagConv2ClpAct=((unsigned long)(&eMagConv2ClpAct)));
(p_OpsMagConvUL1USSMEMAAct=((unsigned long)(&eUSSMEMAAct)));
(p_OpsMagConvUL1AGVMagAct=((unsigned long)(&eAGVMagAct)));

(p_OpsMagConvUL1InitDone=((unsigned long)(&bOpsInitDone)));
(p_OpsMagConvUL1MagBffrAvl=((unsigned long)(&bMagBffrAvl)));
(p_OpsMagConvUL1NewMagAllw=((unsigned long)(&bNewMagAllw)));
(p_OpsMagConvUL1RlsMagAllw=((unsigned long)(&bRlsMagAllw)));
(p_OpsMagConvUL1EjectMESStep=((unsigned long)(&bEjectMESStep)));
(p_OpsMagConvUL1EjectMagNotAllw=((unsigned long)(&bEjectMagNotAllw)));
(p_OpsMagConvUL1StepMagExitedWait=((unsigned long)(&bStepMagExitedWait)));
(p_OpsMagConvUL1StepUSCom=((unsigned long)(&bStepMagUSCom)));
(p_OpsMagConvUL1StepBffrLoad=((unsigned long)(&bStepMagBffrLoad)));
(p_OpsMagConvUL1StepPLCGrab=((unsigned long)(&bStepPLCGrab)));

(p_OpsMagConvUL1StepSelClampCtrl=((unsigned long)(&eSelClampCtrl)));
(p_OpsMagConvUL1NewMagVerified=((unsigned long)(&bNewMagVerified)));
(p_OpsMagConvUL1MagFullExit=((unsigned long)(&bStepMagFullExit)));
(p_OpsMagConvUL1IncorrectMagModel=((unsigned long)(&bIncorrectMagazineModel)));
(p_OpsMagConvUL1MagSizeL=((unsigned long)(&bMagSizeLarge)));

(p_OpsMagConvUL1SafetyBarAct=((unsigned long)(&eSafetyBarAct)));
(p_OpsMagConvUL1MagAWEngageAct=((unsigned long)(&eMagAWEngageAct)));
(p_OpsMagConvUL1MagAWAct=((unsigned long)(&eMagAWAct)));

(p_OpsMagConvUL1USSOTAct=((unsigned long)(&eUSSOTAct)));
(p_OpsMagConvUL1DSSOTAct=((unsigned long)(&eDSSOTAct)));

(p_OpsAGVCommRdy1=((unsigned long)(&bAGVComm1Rdy)));

(p_OpsMagConvUL1MsgReq=((unsigned long)(&tyOpConMsgReq)));

(p_OpsMagConvUL1UnclmpDone=((unsigned long)(&bPneuUnclmpDone)));
(p_OpsMagConvUL1MagAllwGo=((unsigned long)(&udiMagAllwGo)));


(p_OpsMagConvUL1ReadRFID=((unsigned long)(&bReadRFID)));
(p_OpsMagConvUL1WriteRFID=((unsigned long)(&bWriteRFID)));
(p_OpsMagConvUL1AWDone=((unsigned long)(&bStepOpsMagAWDone)));
(p_OpsMagConvUL1SlotUpdtDone=((unsigned long)(&bStepOpsPitchUpdated)));


(p_OpsMagConvUL1AcptTm=((unsigned long)(&dtMagConvAcptTm)));
(p_OpsMagConvUL1MESAcptCond=((unsigned long)(&iMagMESAcptCond)));
(p_OpsMagConvUL1MagExitedWait=((unsigned long)(&bMagExitedWait)));


(p_OpsMagConvUL1TLMuteBuzz=((unsigned long)(&bTLMuteBuzzer)));
(p_OpsMagConvUL1MagFullInfo=((unsigned long)(&bMagFullInfo)));

}}
#line 72 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/OpsMagConv/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/OpsMagConv/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL1/Init.st\\\"\\n\"");
__asm__(".previous");
