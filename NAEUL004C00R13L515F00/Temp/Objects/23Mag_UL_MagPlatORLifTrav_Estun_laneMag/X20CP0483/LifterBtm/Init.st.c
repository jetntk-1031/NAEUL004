...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/LifterBtm/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/Lifter/LifterBtm/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/Lifter/LifterBtm/Init.st"
...
(p_LifterBtmStat=((unsigned long)(&eStat)));
(p_LifterBtmStatus=((unsigned long)(&eMainStatus)));
(p_LifterBtmStatTxt=((unsigned long)(&sStatTxt)));


(p_LifterBtmAlmData=((unsigned long)(&tyAlmData)));
(p_LifterBtmAlmData1=((unsigned long)(&tyAlmData1)));
(p_LifterBtmAlmData2=((unsigned long)(&tyAlmData2)));
(p_LifterBtmAlmData3=((unsigned long)(&tyAlmData3)));


(p_LifterBtmParamOut=((unsigned long)(&tyParamOut)));
(p_LifterBtmPwrOn=((unsigned long)(&tyParamOut.bPwrOn)));
(p_LifterBtmIsHomed=((unsigned long)(&tyParamOut.bIsHomed)));
(p_LifterBtmPosDiff=((unsigned long)(&tyParamOut.bPosDiff)));
(p_LifterBtmAxisErr=((unsigned long)(&tyParamOut.bAxisErr)));
(p_LifterBtmAxisErrID=((unsigned long)(&tyParamOut.udiAxisErrID)));
(p_LifterBtmFwdLmtSen=((unsigned long)(&tyParamOut.bFwdLmtSen)));
(p_LifterBtmRevLmtSen=((unsigned long)(&tyParamOut.bRevLmtSen)));
(p_LifterBtmActualPos=((unsigned long)(&tyParamOut.diActualPosInUM)));
(p_LifterBtmAxisErrTxt=((unsigned long)(&sAxisErrTxt)));
(p_LifterBtmSltAPosDiff=((unsigned long)(&bSltAPosDiff)));
(p_LifterBtmSltBPosDiff=((unsigned long)(&bSltBPosDiff)));
(p_LifterBtmSltCPosDiff=((unsigned long)(&bSltCPosDiff)));
(p_LifterBtmSltDPosDiff=((unsigned long)(&bSltDPosDiff)));
(p_LifterBtmCurrSltA=((unsigned long)(&diCurrSltA)));
(p_LifterBtmCurrSltB=((unsigned long)(&diCurrSltB)));
(p_LifterBtmCurrSltC=((unsigned long)(&diCurrSltC)));
(p_LifterBtmCurrSltD=((unsigned long)(&diCurrSltD)));
(p_LifterBtmAPosDiff=((unsigned long)(&bAPosDiff)));
(p_LifterBtmBPosDiff=((unsigned long)(&bBPosDiff)));
(p_LifterBtmCPosDiff=((unsigned long)(&bCPosDiff)));
(p_LifterBtmDPosDiff=((unsigned long)(&bDPosDiff)));
(p_LifterBtmEPosDiff=((unsigned long)(&bEPosDiff)));
(p_LifterBtmFPosDiff=((unsigned long)(&bFPosDiff)));
(p_LifterBtmGPosDiff=((unsigned long)(&bGPosDiff)));
(p_LifterBtmHPosDiff=((unsigned long)(&bHPosDiff)));
(p_LifterBtmJogging=((unsigned long)(&bJogging)));
(p_LifterBtmUpSen=((unsigned long)(&bUpSen)));
(p_LifterBtmDownSen=((unsigned long)(&bDownSen)));
(p_LifterBtmMovedSlt=((unsigned long)(&iLifterMovedSlot)));


}}
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/Lifter/LifterBtm/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/LifterBtm/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/LifterBtm/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/Lifter/LifterBtm/Init.st\\\"\\n\"");
__asm__(".previous");
