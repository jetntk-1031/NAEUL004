...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/ProdRcp/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/ProdRcp/ProdRcp/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/ProdRcp/ProdRcp/Init.st"
...
(p_ProdRcpCurrRcp0MinSltValue=((unsigned long)(&a_tyCurrRcp[0].diMinSltValue)));
(p_ProdRcpCurrRcp0MaxSltValue=((unsigned long)(&a_tyCurrRcp[0].diMaxSltValue)));
(p_ProdRcpCurrRcp0Pitch=((unsigned long)(&a_tyCurrRcp[0].diPitch)));
(p_ProdRcpCurrRcp0BrdPerSlt=((unsigned long)(&a_tyCurrRcp[0].diBrdPerSlt)));
(p_ProdRcpCurrRcp0McMod=((unsigned long)(&a_tyCurrRcp[0].usiMcMod)));
(p_ProdRcpCurrRcp0TopToBtm=((unsigned long)(&a_tyCurrRcp[0].bTopToBtm)));
(p_ProdRcpCurrRcp0GapBtwnBrd=((unsigned long)(&a_tyCurrRcp[0].bGapBwtnBrd)));
(p_ProdRcpCurrRcp0LongBrd=((unsigned long)(&a_tyCurrRcp[0].bLongBrd)));
(p_ProdRcpCurrRcp0MinReqFreeBffr=((unsigned long)(&a_tyCurrRcp[0].diMinReqFreeBffr)));
...
(p_ProdRcpCurrRcp0PshrPulerOffset=((unsigned long)(&a_tyCurrRcp[0].diPshrOffset)));
(p_ProdRcpCurrRcp0MtrPshrExtSpd=((unsigned long)(&a_tyCurrRcp[0].diMtrPshrExtSpd)));
(p_ProdRcpCurrRcp0MtrPshrExtTorq=((unsigned long)(&a_tyCurrRcp[0].diMtrPshrExtTorq)));
(p_ProdRcpCurrRcp0PshrOffset=((unsigned long)(&a_tyCurrRcp[0].diPshrOffset)));
...
(p_ProdRcpCurrRcp1MinSltValue=((unsigned long)(&a_tyCurrRcp[1].diMinSltValue)));
(p_ProdRcpCurrRcp1MaxSltValue=((unsigned long)(&a_tyCurrRcp[1].diMaxSltValue)));
(p_ProdRcpCurrRcp1Pitch=((unsigned long)(&a_tyCurrRcp[1].diPitch)));
(p_ProdRcpCurrRcp1BrdPerSlt=((unsigned long)(&a_tyCurrRcp[1].diBrdPerSlt)));
(p_ProdRcpCurrRcp1McMod=((unsigned long)(&a_tyCurrRcp[1].usiMcMod)));
(p_ProdRcpCurrRcp1TopToBtm=((unsigned long)(&a_tyCurrRcp[1].bTopToBtm)));
(p_ProdRcpCurrRcp1GapBtwnBrd=((unsigned long)(&a_tyCurrRcp[1].bGapBwtnBrd)));
(p_ProdRcpCurrRcp1LongBrd=((unsigned long)(&a_tyCurrRcp[1].bLongBrd)));
(p_ProdRcpCurrRcp1MinReqFreeBffr=((unsigned long)(&a_tyCurrRcp[1].diMinReqFreeBffr)));
...
(p_ProdRcpCurrRcp1PshrPulerOffset=((unsigned long)(&a_tyCurrRcp[1].diPshrOffset)));
(p_ProdRcpCurrRcp1MtrPshrExtSpd=((unsigned long)(&a_tyCurrRcp[1].diMtrPshrExtSpd)));
(p_ProdRcpCurrRcp1MtrPshrExtTorq=((unsigned long)(&a_tyCurrRcp[1].diMtrPshrExtTorq)));
(p_ProdRcpCurrRcp1PshrOffset=((unsigned long)(&a_tyCurrRcp[1].diPshrOffset)));
...
(p_ProdRcpCurrRcp2MinSltValue=((unsigned long)(&a_tyCurrRcp[2].diMinSltValue)));
(p_ProdRcpCurrRcp2MaxSltValue=((unsigned long)(&a_tyCurrRcp[2].diMaxSltValue)));
(p_ProdRcpCurrRcp2Pitch=((unsigned long)(&a_tyCurrRcp[2].diPitch)));
(p_ProdRcpCurrRcp2BrdPerSlt=((unsigned long)(&a_tyCurrRcp[2].diBrdPerSlt)));
(p_ProdRcpCurrRcp2McMod=((unsigned long)(&a_tyCurrRcp[2].usiMcMod)));
(p_ProdRcpCurrRcp2TopToBtm=((unsigned long)(&a_tyCurrRcp[2].bTopToBtm)));
(p_ProdRcpCurrRcp2GapBtwnBrd=((unsigned long)(&a_tyCurrRcp[2].bGapBwtnBrd)));
(p_ProdRcpCurrRcp2LongBrd=((unsigned long)(&a_tyCurrRcp[2].bLongBrd)));
(p_ProdRcpCurrRcp2MinReqFreeBffr=((unsigned long)(&a_tyCurrRcp[2].diMinReqFreeBffr)));
...
(p_ProdRcpCurrRcp2PshrPulerOffset=((unsigned long)(&a_tyCurrRcp[2].diPshrOffset)));
(p_ProdRcpCurrRcp2MtrPshrExtSpd=((unsigned long)(&a_tyCurrRcp[2].diMtrPshrExtSpd)));
(p_ProdRcpCurrRcp2MtrPshrExtTorq=((unsigned long)(&a_tyCurrRcp[2].diMtrPshrExtTorq)));
(p_ProdRcpCurrRcp2PshrOffset=((unsigned long)(&a_tyCurrRcp[2].diPshrOffset)));
...
(p_ProdRcpCurrRcp3MinSltValue=((unsigned long)(&a_tyCurrRcp[3].diMinSltValue)));
(p_ProdRcpCurrRcp3MaxSltValue=((unsigned long)(&a_tyCurrRcp[3].diMaxSltValue)));
(p_ProdRcpCurrRcp3Pitch=((unsigned long)(&a_tyCurrRcp[3].diPitch)));
(p_ProdRcpCurrRcp3BrdPerSlt=((unsigned long)(&a_tyCurrRcp[3].diBrdPerSlt)));
(p_ProdRcpCurrRcp3McMod=((unsigned long)(&a_tyCurrRcp[3].usiMcMod)));
(p_ProdRcpCurrRcp3TopToBtm=((unsigned long)(&a_tyCurrRcp[3].bTopToBtm)));
(p_ProdRcpCurrRcp3GapBtwnBrd=((unsigned long)(&a_tyCurrRcp[3].bGapBwtnBrd)));
(p_ProdRcpCurrRcp3LongBrd=((unsigned long)(&a_tyCurrRcp[3].bLongBrd)));
(p_ProdRcpCurrRcp3MinReqFreeBffr=((unsigned long)(&a_tyCurrRcp[3].diMinReqFreeBffr)));
...
(p_ProdRcpCurrRcp3PshrPulerOffset=((unsigned long)(&a_tyCurrRcp[3].diPshrOffset)));
(p_ProdRcpCurrRcp3MtrPshrExtSpd=((unsigned long)(&a_tyCurrRcp[3].diMtrPshrExtSpd)));
(p_ProdRcpCurrRcp3MtrPshrExtTorq=((unsigned long)(&a_tyCurrRcp[3].diMtrPshrExtTorq)));
(p_ProdRcpCurrRcp3PshrOffset=((unsigned long)(&a_tyCurrRcp[3].diPshrOffset)));
...
(p_ProdRcpCurrRcp4MinSltValue=((unsigned long)(&a_tyCurrRcp[4].diMinSltValue)));
(p_ProdRcpCurrRcp4MaxSltValue=((unsigned long)(&a_tyCurrRcp[4].diMaxSltValue)));
(p_ProdRcpCurrRcp4Pitch=((unsigned long)(&a_tyCurrRcp[4].diPitch)));
(p_ProdRcpCurrRcp4BrdPerSlt=((unsigned long)(&a_tyCurrRcp[4].diBrdPerSlt)));
(p_ProdRcpCurrRcp4McMod=((unsigned long)(&a_tyCurrRcp[4].usiMcMod)));
(p_ProdRcpCurrRcp4TopToBtm=((unsigned long)(&a_tyCurrRcp[4].bTopToBtm)));
(p_ProdRcpCurrRcp4GapBtwnBrd=((unsigned long)(&a_tyCurrRcp[4].bGapBwtnBrd)));
(p_ProdRcpCurrRcp4LongBrd=((unsigned long)(&a_tyCurrRcp[4].bLongBrd)));
(p_ProdRcpCurrRcp4MinReqFreeBffr=((unsigned long)(&a_tyCurrRcp[4].diMinReqFreeBffr)));
...
(p_ProdRcpCurrRcp4PshrPulerOffset=((unsigned long)(&a_tyCurrRcp[4].diPshrOffset)));
(p_ProdRcpCurrRcp4MtrPshrExtSpd=((unsigned long)(&a_tyCurrRcp[4].diMtrPshrExtSpd)));
(p_ProdRcpCurrRcp4MtrPshrExtTorq=((unsigned long)(&a_tyCurrRcp[4].diMtrPshrExtTorq)));
(p_ProdRcpCurrRcp4PshrOffset=((unsigned long)(&a_tyCurrRcp[4].diPshrOffset)));
...
(p_ProdRcpCurrRcp5MinSltValue=((unsigned long)(&a_tyCurrRcp[5].diMinSltValue)));
(p_ProdRcpCurrRcp5MaxSltValue=((unsigned long)(&a_tyCurrRcp[5].diMaxSltValue)));
(p_ProdRcpCurrRcp5Pitch=((unsigned long)(&a_tyCurrRcp[5].diPitch)));
(p_ProdRcpCurrRcp5BrdPerSlt=((unsigned long)(&a_tyCurrRcp[5].diBrdPerSlt)));
(p_ProdRcpCurrRcp5McMod=((unsigned long)(&a_tyCurrRcp[5].usiMcMod)));
(p_ProdRcpCurrRcp5TopToBtm=((unsigned long)(&a_tyCurrRcp[5].bTopToBtm)));
(p_ProdRcpCurrRcp5GapBtwnBrd=((unsigned long)(&a_tyCurrRcp[5].bGapBwtnBrd)));
(p_ProdRcpCurrRcp5LongBrd=((unsigned long)(&a_tyCurrRcp[5].bLongBrd)));
(p_ProdRcpCurrRcp5MinReqFreeBffr=((unsigned long)(&a_tyCurrRcp[5].diMinReqFreeBffr)));
...
(p_ProdRcpCurrRcp5PshrPulerOffset=((unsigned long)(&a_tyCurrRcp[5].diPshrOffset)));
(p_ProdRcpCurrRcp5MtrPshrExtSpd=((unsigned long)(&a_tyCurrRcp[5].diMtrPshrExtSpd)));
(p_ProdRcpCurrRcp5MtrPshrExtTorq=((unsigned long)(&a_tyCurrRcp[5].diMtrPshrExtTorq)));
(p_ProdRcpCurrRcp5PshrOffset=((unsigned long)(&a_tyCurrRcp[5].diPshrOffset)));
...
#line 151 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/ProdRcp/ProdRcp/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/ProdRcp/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/ProdRcp/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/ProdRcp/ProdRcp/Init.st\\\"\\n\"");
__asm__(".previous");
