...
#line 19 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/MpProdRcp/MpProdRcp/Act_InputConfig.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)tylocalMpProdRcp.In.sPVName; plcstring* zzRValue=(plcstring*)g_tyNtParamCurr.sMpProdRcpPVNm; for(zzIndex=0; zzIndex<100l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)tylocalMpProdRcp.In.sFileName; plcstring* zzRValue=(plcstring*)g_tyNtParamCurr.sMpProdRcpFileNm; for(zzIndex=0; zzIndex<255l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)tylocalMpProdRcp.In.sProgNm; plcstring* zzRValue=(plcstring*)g_tyNtParamCurr.sProdRcpProgNm; for(zzIndex=0; zzIndex<15l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
#line 20 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/MpProdRcp/MpProdRcp/Act_OutputConfig.st"
static void __AS__Action__Act_OutputConfig(void){
{
(g_tyMpProdRcp=*(struct tyMpProdRcpOut1*)&tylocalMpProdRcp.Out);
...
{int zzIndex; plcstring* zzLValue=(plcstring*)sStatTxt; plcstring* zzRValue=(plcstring*)a_sStatText[tylocalMpProdRcp.Out.eStat]; for(zzIndex=0; zzIndex<200l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
(tylocalMpProdRcp.In.tyMpProdRcpMpLink=*(struct MpComIdentType*)&gRecipeXml);

((*(unsigned long*)&(fbMpRecipeRegPar.MpLink))=((unsigned long)(&tylocalMpProdRcp.In.tyMpProdRcpMpLink)));
((*(unsigned long*)&(fbMpRecipeRegPar.PVName))=((unsigned long)(&tylocalMpProdRcp.In.sPVName)));
(fbMpRecipeRegPar.Enable=0);;MpRecipeRegPar(&fbMpRecipeRegPar);

((*(unsigned long*)&(fbMpRecipeXml.MpLink))=((unsigned long)(&tylocalMpProdRcp.In.tyMpProdRcpMpLink)));
((*(unsigned long*)&(fbMpRecipeXml.DeviceName))=((unsigned long)(&"MpProdRcp")));
((*(unsigned long*)&(fbMpRecipeXml.FileName))=((unsigned long)(&tylocalMpProdRcp.In.sFileName)));
...
if((((signed long)tylocalMpProdRcp.Out.eStatus==(signed long)0))){
(tylocalMpProdRcp.Out.eStat=tylocalMpProdRcp.In.eAct);
}


switch(tylocalMpProdRcp.Out.eStat){
...
(tylocalMpProdRcp.Out.eStatus=0);

}break;case 1:{
if(((((signed long)tylocalMpProdRcp.Out.eStatus==(signed long)0))|(((signed long)tylocalMpProdRcp.Out.eStatus==(signed long)2)))){

(tylocalMpProdRcp.Out.eStatus=2);
...
(tylocalMpProdRcp.Out.eStatus=3);
...
(tylocalMpProdRcp.Out.eStatus=1);
...
if(((((signed long)tylocalMpProdRcp.Out.eStatus==(signed long)3))&bRstErr)){
(tylocalMpProdRcp.In.eAct=0);
(tylocalMpProdRcp.Out.eStat=0);
}


if(((((signed long)tylocalMpProdRcp.Out.eStatus==(signed long)1))&(((signed long)tylocalMpProdRcp.In.eAct==(signed long)0)))){
(tylocalMpProdRcp.Out.eStat=0);
}



if(((((signed long)tylocalMpProdRcp.Out.eStatus==(signed long)3))&~Edge0000100000&1?((Edge0000100000=(((signed long)tylocalMpProdRcp.Out.eStatus==(signed long)3))&1),1):((Edge0000100000=(((signed long)tylocalMpProdRcp.Out.eStatus==(signed long)3))&1),0))){

(tylocalMpProdRcp.Out.tyAlmData.udiCode=udiStatus);
(tylocalMpProdRcp.Out.tyAlmData.eSeverity=1);
(tylocalMpProdRcp.Out.tyAlmData.udiRunTime=(tylocalMpProdRcp.Out.tyAlmData.udiRunTime+1));
(tylocalMpProdRcp.Out.tyAlmData.bAlm=1);
(tylocalMpProdRcp.Out.tyAlmData.udiModuleNum=udiModuleNum);
{int zzIndex; plcstring* zzLValue=(plcstring*)g_tyAlmProgNm.sMpProdRcpProgNm; plcstring* zzRValue=(plcstring*)tylocalMpProdRcp.In.sProgNm; for(zzIndex=0; zzIndex<15l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};

}else if((bRstErr&(((unsigned long)tylocalMpProdRcp.Out.tyAlmData.udiCode!=(unsigned long)0)))){

(tylocalMpProdRcp.Out.tyAlmData.udiCode=0);
(tylocalMpProdRcp.Out.tyAlmData.eSeverity=0);
(tylocalMpProdRcp.Out.tyAlmData.bAlm=0);
