...
#ifndef __AS__TYPE_tyNtParamIn1
#define __AS__TYPE_tyNtParamIn1
typedef struct tyNtParamIn1
{	eNtParamAction eAct;
	unsigned long udiRstErr;
	plcstring sFileName[81];
	plcstring sProgNm[81];
	MpComIdentType tyMpNtParamMpLink;
...
#ifndef __AS__TYPE_tyNtParamOut1
#define __AS__TYPE_tyNtParamOut1
typedef struct tyNtParamOut1
{	eNtParamAction eStat;
	eFBStatus eStatus;
	plcstring sStatTxt[201];
	tyAlmDat tyAlmData;
...
#ifndef __AS__TYPE_tyNtParamGen
#define __AS__TYPE_tyNtParamGen
...
_BUR_LOCAL tyNtParamGen tylocalNtParam;
...
_GLOBAL tyNtParamOut1 g_tyNtParamOut;
