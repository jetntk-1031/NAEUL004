...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/USHermesA/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Hermes/USHermesA/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Hermes/USHermesA/Init.st"
...
(p_USHermesAStat=((unsigned long)(&eStat)));
(p_USHermesAStatus=((unsigned long)(&eMainStatus)));
(p_USHermesAStatTxt=((unsigned long)(&sStatTxt)));


(p_USHermesAAlmData=((unsigned long)(&tyAlmData)));
(p_USHermesAAlmData1=((unsigned long)(&tyAlmData1)));
(p_USHermesAAlmData2=((unsigned long)(&tyAlmData2)));
(p_USHermesAAlmData3=((unsigned long)(&tyAlmData3)));
(p_USHermesAAlmData4=((unsigned long)(&tyAlmData4)));
(p_USHermesAAlmData5=((unsigned long)(&tyAlmData5)));
(p_USHermesAInfoData=((unsigned long)(&tyInfoData)));
(p_USHermesAInfoData1=((unsigned long)(&tyInfoData1)));
(p_USHermesAInfoData2=((unsigned long)(&tyInfoData2)));


(p_USHermesATableDataBrdAvl=((unsigned long)(&a_tyXMLTableDataBrdAvl)));
(p_USHermesATableDataBrdAvlTtlIdx=((unsigned long)(&iXMLTableDataBrdAvlTtlIdx)));
(p_USHermesAConnected=((unsigned long)(&bConnected)));
(p_USHermesAHandshakeDone=((unsigned long)(&bHandshakeDone)));
(p_USHermesAAccDataReq=((unsigned long)(&bAccDataReq)));
(p_USHermesABFAccDataReq=((unsigned long)(&bBFAccDataReq)));
(p_USHermesAOverWriteSlt=((unsigned long)(&bOverWriteSlt)));
(p_USHermesAOverWriteWidth=((unsigned long)(&bOverWriteWidth)));
(p_USHermesAReqRecipeNm=((unsigned long)(&sReqRecipeNm)));
(p_USHermesAReqWidthInUM=((unsigned long)(&diReqWidthInUM)));
(p_USHermesAReqMinSltValue=((unsigned long)(&diReqMinSltValue)));
(p_USHermesAReqMaxSltValue=((unsigned long)(&diReqMaxSltValue)));
(p_USHermesAReqPitch=((unsigned long)(&diReqPitch)));
(p_USHermesAUSRdy=((unsigned long)(&bUSRdy)));
(p_USHermesADSRdy=((unsigned long)(&bDSRdy)));
(p_USHermesAUSGdRdy=((unsigned long)(&bUSGdRdy)));
(p_USHermesADSGdRdy=((unsigned long)(&bDSGdRdy)));
(p_USHermesATransporting=((unsigned long)(&bTransporting)));
(p_USHermesAStopTransport=((unsigned long)(&bStopTransport)));
(p_USHermesABlkUS=((unsigned long)(&bBlkUS)));
(p_USHermesAInternalSnd=((unsigned long)(&sInternalSnd)));
(p_USHermesAAccDataMnl=((unsigned long)(&bAccDataMnl)));
(p_USHermesAStopTransportSnd=((unsigned long)(&bStopTransportSnd)));
(p_USHermesABoardArrivedData=((unsigned long)(&tyBoardArrivedInfo)));
(p_USHermesARcvBoardInfoOk=((unsigned long)(&bRcvBoardInfoOk)));
(p_USHermesARcvbBoardInfoIncompl=((unsigned long)(&bRcvBoardInfoIncompl)));
(p_USHermesABoardInfoData=((unsigned long)(&tySendBoardInfoAcc)));
(p_USHermesANextAvlPCBTimer=((unsigned long)(&tNextPCBTm)));
(p_USHermesAManuallInsertLastZone=((unsigned long)(&bManuallInsertLastZone)));
(p_USHermesABoardAvailableRcv=((unsigned long)(&tyBoardAvailableRcv)));
(p_USHermesABoardForecastRcv=((unsigned long)(&tyBoardForecastAcc)));


(p_USHermesABAAccepted=((unsigned long)(&bBaReceivedInRdyState)));
(p_USHermesABFAccepted=((unsigned long)(&bBfReceivedInRdyState)));



(p_USHermesATopBtmBarcode=((unsigned long)(&sTopBtmBarcode)));


}}
#line 65 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Hermes/USHermesA/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/USHermesA/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/USHermesA/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Hermes/USHermesA/Init.st\\\"\\n\"");
__asm__(".previous");
