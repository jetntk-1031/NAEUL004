...
signed short fOpConFormPartProcessed(struct tyXMLTableDat pa_tyXMLTable[84], struct DTStructure(* tyDTStructure), struct tyEventType(* tyEventParam), struct tyLocationParam(* tyLocationParam), struct tyOpConPartProcessed(* tyParam)){signed short __AS__fOpConFormPartProcessed=0;signed long zzIndex00000;signed short iTotalIdxWrite=0;plcstring sTimestamp[24]="";{
