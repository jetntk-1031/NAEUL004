...
signed short fOpConFormPLCGrab(struct tyXMLTableDat pa_tyXMLTable[52], struct DTStructure(* tyDTStructure), struct tyEventType(* tyEventParam), struct tyOpConPLCGrab(* tyParam)){signed short __AS__fOpConFormPLCGrab=0;signed long zzIndex00000;signed short iTotalIdxWrite=0;plcstring sTimestamp[24]="";{
