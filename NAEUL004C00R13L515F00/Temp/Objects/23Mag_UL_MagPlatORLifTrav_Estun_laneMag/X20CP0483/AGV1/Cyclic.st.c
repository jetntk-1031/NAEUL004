...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/AGV1/Cyclicst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.st"
...
#line 40 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_InitGlobal.st"
...
(p_tyLinkBufferStat=p_Buffer1BffrStat);
(p_bLinkAGVOnline=p_AGVOnline);
(p_tyLinkAGVtoDTMag=p_AGVTagAGVToDTMag);
(p_bLinkProjMag1ConvPrep=p_NtParamProjMag1ConvPrep);
...
(p_sProgNm=p_NtParamAGVMag1ProgNm);
(p_diTxInTimeOut=p_McParamMag1ConvRunTmOut);
(p_diTxOutTimeOut=p_McParamMag1ConvRunTmOut);
(p_eDirection=p_NtParamProjMagConvDir);
(p_bBufferMagPresent=p_DIMagPresentSen1);
(p_bMagConvLftSen=p_DIMagPresentSen1);
(p_bMagConvRgtSen=p_DIMagConvEntSen1);
(p_bMagConvMtrIn=p_MagConv2Clp1MtrSigOnOrLToR);
(p_bMagConvMtrOut=p_MagConv2Clp1MtrDirOrRToL);
(p_bNtSettingsLoadDone=p_StartupNtSettingsLoadDone);
(p_bAGVInPosSen1=p_DIMag1AIVInPosSen1);
(p_bAGVInPosSen2=p_DIMag1AIVInPosSen2);
(p_bNtParamAGVInPosSenPrep=p_NtParamProjAIVInPosSenPrep);
(p_bSOTRcvOk=p_DISOT1Receive);
(p_bSOTErr=p_DISOT1Error);
(p_bSOTRdy=p_DISOT1Ready);
(p_bSOTAvailable=p_DISOT1Available);
(p_bEn=p_McParamAGVComEn);



}}
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_LinkAction.st"
static void __AS__Action__Act_LinkAction(void){
{if(((*(p_bLinkProjMag1ConvPrep)))){
(p_eAct=p_OpsMagConvUL1AGVMagAct);
}else if(((*(p_bLinkProjMagConvLane1Prep)))){

}else{
(p_eAct=((unsigned long)(&eAct)));
}

if((~((*(p_bLinkOpsRun)))&Edge0000800000&1?((Edge0000800000=((*(p_bLinkOpsRun)))&1),1):((Edge0000800000=((*(p_bLinkOpsRun)))&1),0))){
((*(p_eAct))=0);
}


}imp8_else1_0:imp8_end1_0:;}
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_LinkEn.st"
...
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_Link.st"
static void __AS__Action__Act_Link(void){
{

if((((unsigned long)(unsigned char)((*(p_bLinkOpsRun)))==(unsigned long)(unsigned char)1))){

(tyDTMagToAGV.bCI1Auto=1);
}else{
(tyDTMagToAGV.bCI1Auto=0);
}

(tyDTMagToAGV.bCI1Occupied=(((*(p_bBufferMagPresent)))|((*(p_bMagConvLftSen)))|((*(p_bMagConvRgtSen)))));

(fbMagFullTm.IN=((((unsigned long)(unsigned char)((*(p_bMagConvRgtSen)))==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bBufferMagPresent)))==(unsigned long)(unsigned char)0))));;TON(&fbMagFullTm);
if((((*(p_bBufferMagPresent)))&((*(p_tyLinkBufferStat)).bBffrFull))){
(tyDTMagToAGV.bCI1MagazineFull=1);
}else if(fbMagFullTm.Q){
(tyDTMagToAGV.bCI1MagazineFull=0);
}

if(((*(p_bLinkAGVOnline)))){

((*(p_tyAGVToDTMag)).bVEHAuto=((*(p_tyLinkAGVtoDTMag)).bVEHAuto));
((*(p_tyAGVToDTMag)).bVEHInPos1=(((*(p_tyLinkAGVtoDTMag)).bVEHInPos1)&bAGVInPosSen));
...
((*(p_tyAGVToDTMag)).bVEHAuto=0);
((*(p_tyAGVToDTMag)).bVEHInPos1=0);
((*(p_tyAGVToDTMag)).bVEHInPos2=0);
((*(p_tyAGVToDTMag)).bVEHInPos3=0);
((*(p_tyAGVToDTMag)).bVEH1Occupied=0);
((*(p_tyAGVToDTMag)).bVEH2Occupied=0);
((*(p_tyAGVToDTMag)).bVEH3Occupied=0);
((*(p_tyAGVToDTMag)).bVEHRunning=0);
...
if(((*(p_bNtParamAGVInPosSenPrep)))){
(fbInPosErrTimer.IN=(((*(p_tyLinkAGVtoDTMag)).bVEHInPos1)&(((unsigned long)(unsigned char)bAGVInPosSen==(unsigned long)(unsigned char)0))));;(fbInPosErrTimer.PT=10000);;TON(&fbInPosErrTimer);
if(fbInPosErrTimer.Q){
(eStatus=3);
(udiStatus=10009);
}
}
...
if(((*(p_bNtParamAGVInPosSenPrep)))){
(bAGVInPosSen=(((*(p_bAGVInPosSen1)))&((*(p_bAGVInPosSen2)))));
}else{
(bAGVInPosSen=1);
}
...
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_RstErr.st"
...
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_InitLocal.st"
...
(p_tyAGVToDTMag=((unsigned long)(&tyAGVToDTMag)));
...
(p_bBufferMagPresent=((unsigned long)(&bBufferMagPresent)));
(p_bMagConvLftSen=((unsigned long)(&bMagConvLftSen)));
(p_bMagConvRgtSen=((unsigned long)(&bMagConvRgtSen)));
(p_bMagConvMtrIn=((unsigned long)(&bMagConvMtrIn)));
(p_bMagConvMtrOut=((unsigned long)(&bMagConvMtrOut)));
(p_bAGVInPosSen1=((unsigned long)(&bAGVInPosSen1)));
(p_bAGVInPosSen2=((unsigned long)(&bAGVInPosSen2)));
(p_bNtParamAGVInPosSenPrep=((unsigned long)(&bNtParamAGVInPosSenPrep)));
}}
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_Initial.st"
...
(fbTxInTimer.IN=0);;TON(&fbTxInTimer);
(fbTxOutTimer.IN=0);;TON(&fbTxOutTimer);
(fbMagOutTrig.CLK=0);;F_TRIG(&fbMagOutTrig);
...
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_Action.st"
...
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_Main.st"
...
(bRdyExit=0);
(bMagConvRun=0);
(fbCheckErrorTim.IN=0);;TON(&fbCheckErrorTim);
(usiStep=0);
...
if((((unsigned long)(unsigned char)usiStep==(unsigned long)(unsigned char)0))){



if(((bAIVAuto&bMagConvAuto)|((*(p_bSOTAvailable))))){

(bMagConvRdy=1);

if((bAIVInPos|((*(p_bSOTRcvOk))))){
...
}else if((((unsigned long)(unsigned char)usiStep==(unsigned long)(unsigned char)1))){

if(((((signed long)((*(p_eDirection)))==(signed long)2))|(((signed long)((*(p_eDirection)))==(signed long)0)))){
(bEndSen=((*(p_bMagConvRgtSen))));
}else{
(bEndSen=((*(p_bMagConvLftSen))));
}

(fbTxInTimer.IN=1);;(fbTxInTimer.PT=(plctime)((*(p_diTxInTimeOut))));;TON(&fbTxInTimer);

if((((unsigned long)(unsigned char)bEndSen==(unsigned long)(unsigned char)1))){
...
}else if((((unsigned long)(unsigned char)fbTxInTimer.Q==(unsigned long)(unsigned char)1))){
...
if(((((unsigned long)(unsigned char)bAIVInPos==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)((*(p_bSOTRcvOk)))==(unsigned long)(unsigned char)0))&(((signed long)eStatus==(signed long)2)))){
...
if(((bAIVAuto&bMagConvAuto)|((*(p_bSOTRdy))))){
...
if(((bAIVInPos|((*(p_bSOTRcvOk))))&(((unsigned long)(unsigned char)bAIVOccupied==(unsigned long)(unsigned char)0)))){

(bMagConvRdy=0);


if((bMagConvOccupied|(((unsigned long)(unsigned char)((*(p_bSOTRdy)))==(unsigned long)(unsigned char)0)))){
...
if(((((signed long)((*(p_eDirection)))==(signed long)0))|(((signed long)((*(p_eDirection)))==(signed long)3)))){
(bEndSen=((*(p_bMagConvRgtSen))));
}else{
(bEndSen=((*(p_bMagConvLftSen))));
}
...
(fbTxOutTimer.IN=1);;(fbTxOutTimer.PT=(plctime)((*(p_diTxOutTimeOut))));;TON(&fbTxOutTimer);


if(((((unsigned long)(unsigned char)bEndSen==(unsigned long)(unsigned char)0))&((((unsigned long)(unsigned char)bAIVOccupied==(unsigned long)(unsigned char)1))|(((unsigned long)(unsigned char)((*(p_bSOTRdy)))==(unsigned long)(unsigned char)0))))){

(usiStep=2);

}else if((((unsigned long)(unsigned char)fbTxOutTimer.Q==(unsigned long)(unsigned char)1))){
...
}else if((((unsigned long)(unsigned char)usiStep==(unsigned long)(unsigned char)2))){
(fbCheckErrorTim.IN=1);;TON(&fbCheckErrorTim);
if(((*(p_bSOTErr)))){
(eStatus=3);
(udiStatus=10010);
}else if(fbCheckErrorTim.Q){
(usiStep=3);
}

}else if((((unsigned long)(unsigned char)usiStep==(unsigned long)(unsigned char)3))){
(bMagConvRdy=1);
...
}imp10_case1_2:imp10_endcase1_0:;}
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_Background.st"
...
#line 41 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Act_Alarm.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)g_sAGVProgNm; plcstring* zzRValue=(plcstring*)((*(p_sProgNm))); for(zzIndex=0; zzIndex<15l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
__asm__(".ascii \"iecfile \\\"Logical/AGVCom/AGV1/InputRef_Link.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/AGVCom/AGV1/InputRef.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/AGVCom/AGV1/Local.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/AGV1/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/AGV1/Cyclic.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/AGVCom/AGV1/Cyclic.st\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/AGV1/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");
