...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/McParam/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/McParam/McParam/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/McParam/McParam/Init.st"
...
(p_McParamMag1ConvRunTmOut=((unsigned long)(&tyMcParamCurr.diMag1ConvRunTmOutInMS)));
(p_McParamMag2ConvRunTmOut=((unsigned long)(&tyMcParamCurr.diMag2ConvRunTmOutInMS)));
(p_McParamMag3ConvRunTmOut=((unsigned long)(&tyMcParamCurr.diMag3ConvRunTmOutInMS)));
(p_McParamOvenMaxBffr=((unsigned long)(&tyMcParamCurr.diOvenMaxBffr)));
(p_McParamTravPosA=((unsigned long)(&tyMcParamCurr.diTravPosA)));
(p_McParamTravPosB=((unsigned long)(&tyMcParamCurr.diTravPosB)));
(p_McParamLifterPosA=((unsigned long)(&tyMcParamCurr.diLifterPosA)));
(p_McParamLifterPosB=((unsigned long)(&tyMcParamCurr.diLifterPosB)));
...
(p_McParamGapBwtnBrdEn=((unsigned long)(&tyMcParamCurr.bGapBwtnBrdEn)));
(p_McParamLongBrdEn=((unsigned long)(&tyMcParamCurr.bLongBrdEn)));
(p_McParamOvenEn=((unsigned long)(&tyMcParamCurr.bOvenEn)));
(p_McParamExtdOvenEn=((unsigned long)(&tyMcParamCurr.bExtdOvenEn)));
(p_McParamInShutterDis=((unsigned long)(&tyMcParamCurr.bInShutterDis)));
(p_McParamStopperADis=((unsigned long)(&tyMcParamCurr.bStopperADis)));
(p_McParamStopperBDis=((unsigned long)(&tyMcParamCurr.bStopperBDis)));
(p_McParamMagAutoDetTm=((unsigned long)(&tyMcParamCurr.diMagAutoDetectSenTmInMS)));
(p_McParamAGVComEn=((unsigned long)(&tyMcParamCurr.bAGVComEn)));
...
(p_McParamConvLftSenAntiGap=((unsigned long)(&tyMcParamCurr.tyLftSenAntiGapDly)));
(p_McParamConvLftSenOnTm=((unsigned long)(&tyMcParamCurr.tyLftSenAntiGapDly.diSigOnTm)));
(p_McParamConvLftSenOffTm=((unsigned long)(&tyMcParamCurr.tyLftSenAntiGapDly.diSigOffTm)));
(p_McParamConvMidSenAntiGap=((unsigned long)(&tyMcParamCurr.tyMidSenAntiGapDly)));
(p_McParamConvMidSenOnTm=((unsigned long)(&tyMcParamCurr.tyMidSenAntiGapDly.diSigOnTm)));
(p_McParamConvMidSenOffTm=((unsigned long)(&tyMcParamCurr.tyMidSenAntiGapDly.diSigOffTm)));
(p_McParamConvRgtSenAntiGap=((unsigned long)(&tyMcParamCurr.tyRgtSenAntiGapDly)));
(p_McParamConvRgtSenOnTm=((unsigned long)(&tyMcParamCurr.tyRgtSenAntiGapDly.diSigOnTm)));
(p_McParamConvRgtSenOffTm=((unsigned long)(&tyMcParamCurr.tyRgtSenAntiGapDly.diSigOffTm)));
(p_McParamConvClrSenAntGap=((unsigned long)(&tyMcParamCurr.tyClrSenAntiGapDly)));
(p_McParamConvClrSenOnTm=((unsigned long)(&tyMcParamCurr.tyClrSenAntiGapDly.diSigOnTm)));
(p_McParamConvClrSenOffTm=((unsigned long)(&tyMcParamCurr.tyClrSenAntiGapDly.diSigOffTm)));


(p_McParamMagConvEntrySenAntiGap=((unsigned long)(&tyMcParamCurr.tyMagConvEntrySenAntiGapDly)));
(p_McParamMagConvEntrySenOnTm=((unsigned long)(&tyMcParamCurr.tyMagConvEntrySenAntiGapDly.diSigOnTm)));
(p_McParamMagConvEntrySenOffTm=((unsigned long)(&tyMcParamCurr.tyMagConvEntrySenAntiGapDly.diSigOffTm)));

(p_McParamMagConvPresentAntiGap=((unsigned long)(&tyMcParamCurr.tyMagConvPresentSenAntiGapDly)));
(p_McParamMagConvPresentSenOnTm=((unsigned long)(&tyMcParamCurr.tyMagConvPresentSenAntiGapDly.diSigOnTm)));
(p_McParamMagConvPresentSenOffTm=((unsigned long)(&tyMcParamCurr.tyMagConvPresentSenAntiGapDly.diSigOffTm)));

(p_McParamUSCommAMod=((unsigned long)(&tyMcParamCurr.eUSCommA)));
(p_McParamUSSMEMAAParam=((unsigned long)(&tyMcParamCurr.tyUSCommASMEMA)));
(p_McParamUSSMEMAASelection=((unsigned long)(&tyMcParamCurr.tyUSCommASMEMA.eSelection)));
(p_McParamUBAAStatSetGd=((unsigned long)(&tyMcParamCurr.tyUSCommASMEMA.bStatSigSetGd)));

(p_McParamUSCommBMod=((unsigned long)(&tyMcParamCurr.eUSCommB)));
(p_McParamUSSMEMABParam=((unsigned long)(&tyMcParamCurr.tyUSCommBSMEMA)));
(p_McParamUSSMEMABSelection=((unsigned long)(&tyMcParamCurr.tyUSCommBSMEMA.eSelection)));
(p_McParamUBABStatSetGd=((unsigned long)(&tyMcParamCurr.tyUSCommBSMEMA.bStatSigSetGd)));
...
(p_McParamMagAWDis=((unsigned long)(&tyMcParamCurr.bMagAWDis)));
(p_McParamMagSafetyBarDis=((unsigned long)(&tyMcParamCurr.bMagSafetyBarDis)));
(p_McParamMag1WidthAtHmPos=((unsigned long)(&tyMcParamCurr.diMag1WidthAtHmPosInUM)));
(p_McParamMag2WidthAtHmPos=((unsigned long)(&tyMcParamCurr.diMag2WidthAtHmPosInUM)));
(p_McParamMag3WidthAtHmPos=((unsigned long)(&tyMcParamCurr.diMag3WidthAtHmPosInUM)));
(p_McParamLFBuzMute=((unsigned long)(&tyMcParamCurr.bLFBuzMute)));

(p_McParamAGVComProtocol=((unsigned long)(&tyMcParamCurr.eAGVComProtocol)));
(p_McParamMagExMode=((unsigned long)(&tyMcParamCurr.eMagExMode)));

(p_McParamAWPusherAtHmPos=((unsigned long)(&tyMcParamCurr.diAWPusherAtHmPosInUM)));
(p_McParamAWPusherDis=((unsigned long)(&tyMcParamCurr.bAWPusherDis)));


(p_McParamTravInletFixtoFixPos=((unsigned long)(&tyMcParamCurr.diTravInletFixtoFixPos)));
(p_McParamDisableFMWarning=((unsigned long)(&tyMcParamCurr.bDisableFMWarning)));

(p_McParamConvLineAInletSenOnTm=((unsigned long)(&tyMcParamCurr.tyLineAInletSenAntiGapDly.diSigOnTm)));
(p_McParamConvLineAInletSenOffTm=((unsigned long)(&tyMcParamCurr.tyLineAInletSenAntiGapDly.diSigOffTm)));
(p_McParamConvLineBInletSenOnTm=((unsigned long)(&tyMcParamCurr.tyLineBInletSenAntiGapDly.diSigOnTm)));
(p_McParamConvLineBInletSenOffTm=((unsigned long)(&tyMcParamCurr.tyLineBInletSenAntiGapDly.diSigOffTm)));
(p_McParamUSWidthChkSenOnTm=((unsigned long)(&tyMcParamCurr.tyUSWidthChkSenAntiGapDly.diSigOnTm)));
(p_McParamUSWidthChkSenOffTm=((unsigned long)(&tyMcParamCurr.tyUSWidthChkSenAntiGapDly.diSigOffTm)));

(p_McParamDBAOnWOAlign=((unsigned long)(&tyMcParamCurr.bDBAOnWOAlign)));


(p_McParamInMagConvEntSenOnTm=((unsigned long)(&tyMcParamCurr.tyInMagConvEntAntiGapDly.diSigOnTm)));
(p_McParamInMagConvEntSenOffTm=((unsigned long)(&tyMcParamCurr.tyInMagConvEntAntiGapDly.diSigOffTm)));
(p_McParamInMagConvExtSenOnTm=((unsigned long)(&tyMcParamCurr.tyInMagConvExtAntiGapDly.diSigOnTm)));
(p_McParamInMagConvExtSenOffTm=((unsigned long)(&tyMcParamCurr.tyInMagConvExtAntiGapDly.diSigOffTm)));
(p_McParamInMagConvMidSenOnTm=((unsigned long)(&tyMcParamCurr.tyInMagConvMidAntiGapDly.diSigOnTm)));
(p_McParamInMagConvMidSenOffTm=((unsigned long)(&tyMcParamCurr.tyInMagConvMidAntiGapDly.diSigOffTm)));

(p_McParamOutMagConvEntSenOnTm=((unsigned long)(&tyMcParamCurr.tyOutMagConvEntAntiGapDly.diSigOnTm)));
(p_McParamOutMagConvEntSenOffTm=((unsigned long)(&tyMcParamCurr.tyOutMagConvEntAntiGapDly.diSigOffTm)));
(p_McParamOutMagConvExtSenOnTm=((unsigned long)(&tyMcParamCurr.tyOutMagConvExtAntiGapDly.diSigOnTm)));
(p_McParamOutMagConvExtSenOffTm=((unsigned long)(&tyMcParamCurr.tyOutMagConvExtAntiGapDly.diSigOffTm)));
(p_McParamOutMagConvMidSenOnTm=((unsigned long)(&tyMcParamCurr.tyOutMagConvMidAntiGapDly.diSigOnTm)));
(p_McParamOutMagConvMidSenOffTm=((unsigned long)(&tyMcParamCurr.tyOutMagConvMidAntiGapDly.diSigOffTm)));

(p_McParamInMagConv2EntSenOnTm=((unsigned long)(&tyMcParamCurr.tyInMagConv2EntAntiGapDly.diSigOnTm)));
(p_McParamInMagConv2EntSenOffTm=((unsigned long)(&tyMcParamCurr.tyInMagConv2EntAntiGapDly.diSigOffTm)));
(p_McParamInMagConv2ExtSenOnTm=((unsigned long)(&tyMcParamCurr.tyInMagConv2ExtAntiGapDly.diSigOnTm)));
(p_McParamInMagConv2ExtSenOffTm=((unsigned long)(&tyMcParamCurr.tyInMagConv2ExtAntiGapDly.diSigOffTm)));
(p_McParamInMagConv2MidSenOnTm=((unsigned long)(&tyMcParamCurr.tyInMagConv2MidAntiGapDly.diSigOnTm)));
(p_McParamInMagConv2MidSenOffTm=((unsigned long)(&tyMcParamCurr.tyInMagConv2MidAntiGapDly.diSigOffTm)));

(p_McParamOutMagConv2EntSenOnTm=((unsigned long)(&tyMcParamCurr.tyOutMagConv2EntAntiGapDly.diSigOnTm)));
(p_McParamOutMagConv2EntSenOffTm=((unsigned long)(&tyMcParamCurr.tyOutMagConv2EntAntiGapDly.diSigOffTm)));
(p_McParamOutMagConv2ExtSenOnTm=((unsigned long)(&tyMcParamCurr.tyOutMagConv2ExtAntiGapDly.diSigOnTm)));
(p_McParamOutMagConv2ExtSenOffTm=((unsigned long)(&tyMcParamCurr.tyOutMagConv2ExtAntiGapDly.diSigOffTm)));
(p_McParamOutMagConv2MidSenOnTm=((unsigned long)(&tyMcParamCurr.tyOutMagConv2MidAntiGapDly.diSigOnTm)));
(p_McParamOutMagConv2MidSenOffTm=((unsigned long)(&tyMcParamCurr.tyOutMagConv2MidAntiGapDly.diSigOffTm)));

(p_McParamInMagConvRunTmOut=((unsigned long)(&tyMcParamCurr.diInMagConvRunTmOutInMS)));
(p_McParamOutMagConvRunTmOut=((unsigned long)(&tyMcParamCurr.diOutMagConvRunTmOutInMS)));
(p_McParamLifterMagConvRunTmOut=((unsigned long)(&tyMcParamCurr.diLifterMagConvRunTmOutInMS)));
(p_McParamInMagConv2RunTmOut=((unsigned long)(&tyMcParamCurr.diInMagConv2RunTmOutInMS)));
(p_McParamOutMagConv2RunTmOut=((unsigned long)(&tyMcParamCurr.diOutMagConv2RunTmOutInMS)));
(p_McParamLifterMagConv2RunTmOut=((unsigned long)(&tyMcParamCurr.diLifterMagConv2RunTmOutInMS)));
(p_McParamLifterTopPos=((unsigned long)(&tyMcParamCurr.diLifterTopPos)));
(p_McParamLifterBtmPos=((unsigned long)(&tyMcParamCurr.diLifterBtmPos)));
(p_McParamLifterTopPos2=((unsigned long)(&tyMcParamCurr.diLifterTopPos2)));
(p_McParamLifterBtmPos2=((unsigned long)(&tyMcParamCurr.diLifterBtmPos2)));
(p_McParamTCPSvrPort=((unsigned long)(&tyMcParamCurr.diTCPSvrPort)));
(p_McParamMagWidthChkDis=((unsigned long)(&tyMcParamCurr.bMagWidthChkDis)));
(p_McParamMag1WidthChkDetDist=((unsigned long)(&tyMcParamCurr.diMag1WidthChkDetDist)));
(p_McParamMag2WidthChkDetDist=((unsigned long)(&tyMcParamCurr.diMag2WidthChkDetDist)));
(p_McParamMag3WidthChkDetDist=((unsigned long)(&tyMcParamCurr.diMag3WidthChkDetDist)));
(p_McParamTopScannerEn=((unsigned long)(&tyMcParamCurr.bTopScannerEn)));
(p_McParamBtmScannerEn=((unsigned long)(&tyMcParamCurr.bBtmScannerEn)));
(p_McParamTopScanIP=((unsigned long)(&tyMcParamCurr.sTopScanIPAddr)));
(p_McParamTopScanPort=((unsigned long)(&tyMcParamCurr.uiTopScanSvrPort)));
(p_McParamBtmScanIP=((unsigned long)(&tyMcParamCurr.sBtmScanIPAddr)));
(p_McParamBtmScanPort=((unsigned long)(&tyMcParamCurr.uiBtmScanSvrPort)));
(p_McParamOpConEn=((unsigned long)(&tyMcParamCurr.bOpConEn)));
(p_McParamOpConIP=((unsigned long)(&tyMcParamCurr.sOpConIPAddr)));
(p_McParamOpConPort=((unsigned long)(&tyMcParamCurr.uiOpConSvrPort)));
(p_McParamOpConParam=((unsigned long)(&tyMcParamCurr.tyOpConParam)));


(p_McParamSiemensPrep=((unsigned long)(&tyMcParamCurr.bSiemensPrep)));
(p_McParamHermesSvyEn=((unsigned long)(&tyMcParamCurr.bHermesSvyEn)));
(p_McParamHermesScannerEn=((unsigned long)(&tyMcParamCurr.bHermesScannerEn)));

(p_McParamInStopperDis=((unsigned long)(&tyMcParamCurr.bInStopperDis)));
(p_McParamInStopperExtDelayTm=((unsigned long)(&tyMcParamCurr.diInletStopperExtDelayTmInMS)));
(p_McParamMESEn=((unsigned long)(&tyMcParamCurr.bMESEn)));
(p_McParamMESResponseTO=((unsigned long)(&tyMcParamCurr.diMESResponseTOTmInMS)));
(p_McParamSwitchingProdType=((unsigned long)(&tyMcParamCurr.bSwitchingProdType)));
(p_McParamAutoRcpDisable=((unsigned long)(&tyMcParamCurr.bAutoRcpDisable)));
(p_McParamAutoRcpBatchIDChgCmp=((unsigned long)(&tyMcParamCurr.bBatchIDChgOverCmp)));
(p_McParamAutoRcpIgnoreBtmClr=((unsigned long)(&tyMcParamCurr.bIgnoreBtmClearance)));
(p_McParamAutoRcpIgnoreTopClr=((unsigned long)(&tyMcParamCurr.bIgnoreTopClearance)));
(p_McParamAutoRcpIgnoreThickns=((unsigned long)(&tyMcParamCurr.bIgnoreThickness)));

(p_McParamDMCScannerEn=((unsigned long)(&tyMcParamCurr.bDMCScannerEn)));
(p_McParamDMCScanWriteTO=((unsigned long)(&tyMcParamCurr.diDMCScanTOErrInMs)));

(p_McParamDefaultGateway=((unsigned long)(&tyMcParamCurr.sDefaultGateWay)));



}}
#line 216 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/McParam/McParam/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/McParam/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/McParam/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/McParam/McParam/Init.st\\\"\\n\"");
__asm__(".previous");
