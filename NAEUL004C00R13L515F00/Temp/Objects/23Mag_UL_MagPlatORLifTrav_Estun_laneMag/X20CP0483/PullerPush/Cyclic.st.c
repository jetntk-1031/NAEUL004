...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/PullerPush/Cyclicst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.st"
...
#line 50 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_InitGlobal.st"
...
(p_bLinkPullConvPullerExtCtrl=p_PshrConvPshrExtCtrl);
(p_bLinkPullConvPullerRetCtrl=p_PshrConvPshrRetCtrl);
(p_bLinkDIPullerExtRS=p_DIPusherExtRS);
(p_bLinkDIPullerRetRS=p_DIPusherRetRS);
(p_bLinkDIPullerExtSlwRS=p_DIPusherExtSlwSen);
(p_bLinkDIPullerRetSlwRS=p_DIPusherRetSlwSen);
(p_dintLinkPullerRetSpd=p_ProdRcpCurrRcp1MtrPshrExtSpd);
(p_dintLinkPullerRetTrq=p_ProdRcpCurrRcp1MtrPshrExtTorq);

(p_diLinkProdRcpTrq=p_ProdRcpCurrRcp1MtrPshrExtTorq);
(p_tyLinkTorqParam=p_NtParamPPTorqParam);


(p_udiRstErr=p_RstErrReset);
(p_bPrep=p_NtParamProjServoPullPusherPrep);
(p_bOps=p_OpsStatusRun);
(p_bManual=p_UIMnlMod);
(p_tyTuning=p_NtParamPPTuning);

(p_diMovePosInUM=p_UIMnlPPTargetPos);
(p_diMoveDistInUM=p_UIMnlPPStepSize);
(p_diMoveAcc=p_NtParamPPAcc);
(p_diMoveDec=p_NtParamPPDec);
(p_diWidthOffsetInUM=p_NtParamWidthOffset);
(p_bDir=p_NtParamPPDir);
(p_bDirBl=p_NtParamPPDirBl);
(p_usiNode=p_NtParamPPNode);
(p_sDevice=p_NtParamPPDevice);
(p_sProgNm=p_NtParamPPProgNm);
(p_diMoveBacklashDistInUM=p_NtParamPPMovBlDistInUM);
(p_diPitchInUM=p_NtParamPPPitchInUM);
(p_tyParamInHm=p_NtParamPPParamInHm);
(p_tyParamInConvert=p_NtParamPPParamInConvert);
(p_bNtSettingsLoadDone=p_StartupNtSettingsLoadDone);
(p_eNtParamMotorType=p_NtParamPPMotorType);
...
(p_bMagWidthChkSen=p_DIMagWidthChkSen);



}}
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_LinkAction.st"
...
(p_eAct=p_StartupServoPPAct);
}else if(((((unsigned long)(unsigned char)((*(p_bLinkOpsRun)))==(unsigned long)(unsigned char)1))|(((unsigned long)(unsigned char)((*(p_bManual)))==(unsigned long)(unsigned char)1)))){


if((((*(p_bLinkPullConvPullerExtCtrl)))&(bJogFwdDone^1))){
(bJogStopDone=0);

switch(usiJogFwdStep){

case 0:{


(diMtrPshrExtTrq=(((*(p_tyLinkTorqParam)).usiStartTorque)+(((signed long)(((((signed long)((((*(p_diLinkProdRcpTrq)))-10)))/((signed long)(10)))*((*(p_tyLinkTorqParam)).uiRatio))))/((signed long)(100)))));

if(((*(p_bManual)))){
__AS__MEMCPY(((unsigned long)(&fbSDOWriteTorque.data0)),p_UIMnlMtrPshrExtTorq,1);
__AS__MEMCPY(((unsigned long)(&fbSDOWriteTorque.data1)),(p_UIMnlMtrPshrExtTorq+1),1);
}else{



__AS__MEMCPY(((unsigned long)(&fbSDOWriteTorque.data0)),((unsigned long)(&diMtrPshrExtTrq)),1);
__AS__MEMCPY(((unsigned long)(&fbSDOWriteTorque.data1)),(((unsigned long)(&diMtrPshrExtTrq))+1),1);
}
...
(fbSDOWriteTorque.enable=1);;CANopenSDOWrite8(&fbSDOWriteTorque);
if((((unsigned long)(unsigned short)fbSDOWriteTorque.status==(unsigned long)(unsigned short)65535))){
(usiJogFwdStep=22);
}

}break;case 22:{
(fbSDOWriteTorque.enable=1);;CANopenSDOWrite8(&fbSDOWriteTorque);
if((((unsigned long)(unsigned short)fbSDOWriteTorque.status==(unsigned long)(unsigned short)0))){
(fbSDOWriteTorque.enable=0);;CANopenSDOWrite8(&fbSDOWriteTorque);
(usiJogFwdStep=30);
}

}break;case 30:{
if((((unsigned long)(unsigned char)tyParamOut.bPwrOn==(unsigned long)(unsigned char)0))){
((*(p_eAct))=3);

if(tyParamOut.bPwrOn){
((*(p_eAct))=0);
(usiJogFwdStep=40);
}
}else{
...
if((((*(p_bLinkDIPullerExtSlwRS)))&~Edge0001200000&1?((Edge0001200000=((*(p_bLinkDIPullerExtSlwRS)))&1),1):((Edge0001200000=((*(p_bLinkDIPullerExtSlwRS)))&1),0))){
((*(p_eAct))=0);
}

if((((*(p_bLinkDIPullerExtSlwRS)))|((*(p_bLinkDIPullerExtRS))))){

((*(p_diJogVelInUMPS))=diExtSlowSpeed);

}else{
if(((*(p_bManual)))){
(p_diJogVelInUMPS=p_UIMnlPPJogSpd);
}else{
((*(p_diJogVelInUMPS))=(((*(p_dintLinkPullerRetSpd)))*3000));
}
}
...
if(((((signed long)eStat==(signed long)10))&(((signed long)eMainStatus==(signed long)1)))){
((*(p_eAct))=0);
(usiJogFwdStep=0);
(bJogFwdDone=1);
}
...
else if((((*(p_bLinkPullConvPullerRetCtrl)))&(bJogRevDone^1))){

(bJogStopDone=0);
switch(usiJogRevStep){

case 0:{
__AS__MEMCPY(((unsigned long)(&fbSDOWriteTorque.data0)),((unsigned long)(&udiMaxTorque)),1);
__AS__MEMCPY(((unsigned long)(&fbSDOWriteTorque.data1)),(((unsigned long)(&udiMaxTorque))+1),1);
...
if((((*(p_bLinkDIPullerRetSlwRS)))&~Edge0001200001&1?((Edge0001200001=((*(p_bLinkDIPullerRetSlwRS)))&1),1):((Edge0001200001=((*(p_bLinkDIPullerRetSlwRS)))&1),0))){
((*(p_eAct))=0);
}

if((((*(p_bLinkDIPullerRetSlwRS)))|((*(p_bLinkDIPullerRetRS))))){
...
if((((unsigned long)(unsigned char)bJogStopDone==(unsigned long)(unsigned char)0))){
((*(p_eAct))=10);
}
...
if((((unsigned long)(unsigned short)tyParamInDriver.uiErrCode_603F!=(unsigned long)(unsigned short)0))){
...
((*(p_eAct))=0);
if(((((signed long)eStat==(signed long)0))&(((signed long)eMainStatus==(signed long)1)))){
((*(p_eAct))=0);
}
}
}
...
if(((~((*(p_bManual)))&Edge0001200002&1?((Edge0001200002=((*(p_bManual)))&1),1):((Edge0001200002=((*(p_bManual)))&1),0))|(~((*(p_bLinkOpsRun)))&Edge0001200003&1?((Edge0001200003=((*(p_bLinkOpsRun)))&1),1):((Edge0001200003=((*(p_bLinkOpsRun)))&1),0))|(~((*(p_bLinkStartupRun)))&Edge0001200004&1?((Edge0001200004=((*(p_bLinkStartupRun)))&1),1):((Edge0001200004=((*(p_bLinkStartupRun)))&1),0)))){
(tyParamOutDriver.uiCtrlword_6040=0);
}



if((((((signed long)eStat==(signed long)9))&((*(p_bLinkDIPullerRetRS))))|((((signed long)eStat==(signed long)8))&((*(p_bLinkDIPullerExtRS)))))){
((*(p_diJogVelInUMPS))=0);
}

if((((unsigned long)(unsigned char)((*(p_bLinkDIPullerRetRS)))==(unsigned long)(unsigned char)0))){
(bJogRevDone=0);
}

if((((unsigned long)(unsigned char)((*(p_bLinkDIPullerExtRS)))==(unsigned long)(unsigned char)0))){
(bJogFwdDone=0);
}

}imp12_else34_0:imp12_end34_0:;}
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_LinkEn.st"
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Link.st"
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_InitLocal.st"
...
(p_diServoTorque=((unsigned long)(&diServoTorque)));

}}
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_RstErr.st"
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Initial.st"
...
(fbSDOWriteTorque.pDevice=((unsigned long)(&((*(p_sDevice))))));
(fbSDOWriteTorque.node=((*(p_usiNode))));
(fbSDOWriteTorque.index=8460);
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Action.st"
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Main.st"
...
}imp14_case49_5:imp14_endcase49_0:imp14_end0_0:;}
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Main_Disable.st"
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Background.st"
...
if((((((unsigned long)(unsigned char)bNotInterruptible==(unsigned long)(unsigned char)1))|bJogging)&(((signed long)eStatus3!=(signed long)3)))){
...
}imp6_else30_0:imp6_end30_0:;}
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_CombineErr.st"
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Alarm.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)g_sAWCloseProgNm; plcstring* zzRValue=(plcstring*)((*(p_sProgNm))); for(zzIndex=0; zzIndex<15l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Alarm1.st"
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Alarm2.st"
...
#line 51 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Act_Alarm3.st"
...
__asm__(".ascii \"iecfile \\\"Logical/CANOpenServo/PullerPusher/PullerPusher/InputRef_Link.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/CANOpenServo/PullerPusher/PullerPusher/InputRef.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/CANOpenServo/PullerPusher/PullerPusher/Local.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/PullerPush/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/PullerPush/Cyclic.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/CANOpenServo/PullerPusher/PullerPusher/Cyclic.st\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/PullerPush/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");
