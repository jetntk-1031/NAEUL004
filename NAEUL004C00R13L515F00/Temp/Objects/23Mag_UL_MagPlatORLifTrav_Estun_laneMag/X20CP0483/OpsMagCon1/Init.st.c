...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/OpsMagCon1/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Init.st"
...
(p_OpsMagConvUL2AlmData=((unsigned long)(&tyAlmData)));
(p_OpsMagConvUL2AlmData1=((unsigned long)(&tyAlmData1)));


(p_OpsMagConvUL2StepTxt=((unsigned long)(&sStepTxt)));
(p_OpsMagConvUL2Paused=((unsigned long)(&bPaused)));

(p_OpsMagConvUL2BufferAct=((unsigned long)(&eBufferAct)));
(p_OpsMagConvUL2MagConv2ClpAct=((unsigned long)(&eMagConv2ClpAct)));
(p_OpsMagConvUL2USSMEMAAct=((unsigned long)(&eUSSMEMAAct)));
(p_OpsMagConvUL2AGVMagAct=((unsigned long)(&eAGVMagAct)));

(p_OpsMagConvUL2InitDone=((unsigned long)(&bOpsInitDone)));
(p_OpsMagConvUL2MagBffrAvl=((unsigned long)(&bMagBffrAvl)));
(p_OpsMagConvUL2NewMagAllw=((unsigned long)(&bNewMagAllw)));
(p_OpsMagConvUL2RlsMagAllw=((unsigned long)(&bRlsMagAllw)));
(p_OpsMagConvUL2EjectMESStep=((unsigned long)(&bEjectMESStep)));
(p_OpsMagConvUL2EjectMagNotAllw=((unsigned long)(&bEjectMagNotAllw)));
(p_OpsMagConvUL2StepMagExitedWait=((unsigned long)(&bStepMagExitedWait)));
(p_OpsMagConvUL2StepUSCom=((unsigned long)(&bStepMagUSCom)));
(p_OpsMagConvUL2StepPLCGrab=((unsigned long)(&bStepPLCGrab)));

(p_OpsMagConvUL2StepSelClampCtrl=((unsigned long)(&eSelClampCtrl)));
(p_OpsMagConvUL2NewMagVerified=((unsigned long)(&bNewMagVerified)));
(p_OpsMagConvUL2MagFullExit=((unsigned long)(&bStepMagFullExit)));
(p_OpsMagConvUL2IncorrectMagModel=((unsigned long)(&bIncorrectMagazineModel)));
(p_OpsMagConvUL2MagSizeL=((unsigned long)(&bMagSizeLarge)));

(p_OpsMagConvUL2SafetyBarAct=((unsigned long)(&eSafetyBarAct)));
(p_OpsMagConvUL2MagAWEngageAct=((unsigned long)(&eMagAWEngageAct)));
(p_OpsMagConvUL2MagAWAct=((unsigned long)(&eMagAWAct)));


(p_OpsMagConvUL2USSOTAct=((unsigned long)(&eUSSOTAct)));
(p_OpsMagConvUL2DSSOTAct=((unsigned long)(&eDSSOTAct)));

(p_OpsAGVCommRdy2=((unsigned long)(&bAGVComm2Rdy)));

(p_OpsMagConvUL2UnclmpDone=((unsigned long)(&bPneuUnclmpDone)));
(p_OpsMagConvUL2MagAllwGo=((unsigned long)(&udiMagAllwGo)));

(p_OpsMagConvUL2ReadRFID=((unsigned long)(&bReadRFID)));
(p_OpsMagConvUL2WriteRFID=((unsigned long)(&bWriteRFID)));
(p_OpsMagConvUL2AWDone=((unsigned long)(&bStepOpsMagAWDone)));
(p_OpsMagConvUL2SlotUpdtDone=((unsigned long)(&bStepOpsPitchUpdated)));


(p_OpsMagConvUL2AcptTm=((unsigned long)(&dtMagConvAcptTm)));
(p_OpsMagConvUL2MESAcptCond=((unsigned long)(&iMagMESAcptCond)));
(p_OpsMagConvUL2MagExitedWait=((unsigned long)(&bMagExitedWait)));
}}
#line 63 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/OpsMagCon1/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/OpsMagCon1/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/MagConv_StationaryPlat/OpsMagConvUL2/Init.st\\\"\\n\"");
__asm__(".previous");
