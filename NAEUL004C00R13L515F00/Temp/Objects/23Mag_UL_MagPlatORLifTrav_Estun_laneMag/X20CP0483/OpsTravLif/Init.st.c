...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/OpsTravLif/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/OpsTravLifUL/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/OpsTravLifUL/Init.st"
...
(p_OpsTravLifULAlmData=((unsigned long)(&tyAlmData)));


(p_OpsTravLifULStepTxt=((unsigned long)(&sStepTxt)));
(p_OpsTravLifULPaused=((unsigned long)(&bPaused)));

(p_OpsTravLifULUSSMEMAAct1=((unsigned long)(&eUSSMEMAAct1)));
(p_OpsTravLifULUSSMEMAAct2=((unsigned long)(&eUSSMEMAAct2)));
(p_OpsTravLifULUSSMEMAAct3=((unsigned long)(&eUSSMEMAAct3)));
(p_OpsTravLifULDSSMEMAAct1=((unsigned long)(&eDSSMEMAAct1)));
(p_OpsTravLifULDSSMEMAAct2=((unsigned long)(&eDSSMEMAAct2)));
(p_OpsTravLifULDSSMEMAAct3=((unsigned long)(&eDSSMEMAAct3)));
(p_OpsTravLifULConvAct=((unsigned long)(&eConvAct)));
(p_OpsTravLifULAWAct=((unsigned long)(&eAWAct)));
(p_OpsTravLifULAWPushPullAct=((unsigned long)(&eAWPushOrPullerAct)));
(p_OpsTravLifULTravAct=((unsigned long)(&eTravAct)));
(p_OpsTravLifULLifAct=((unsigned long)(&eLifAct)));
(p_OpsTravLifULInletPneuAct=((unsigned long)(&eInletPneuAct)));
(p_OpsTravLifULOutletPneuAct=((unsigned long)(&eOutletPneuAct)));
(p_OpsTravLifULOutletPneuAct2=((unsigned long)(&eOutletPneuAct2)));
(p_OpsTravLifULOutletPneuAct3=((unsigned long)(&eOutletPneuAct3)));
(p_OpsTravLifULStopperAct1=((unsigned long)(&eStopperAct1)));
(p_OpsTravLifULStopperAct2=((unsigned long)(&eStopperAct2)));
(p_OpsTravLifULStopperAct3=((unsigned long)(&eStopperAct3)));

(p_OpsTravLifULPosGo=((unsigned long)(&eTravLifPosGo)));
(p_OpsTravLifULMagDis=((unsigned long)(&a_bMagDis)));
(p_OpsTravLifULMagRej=((unsigned long)(&a_bMagRej)));
(p_OpsTravLifULInitConv=((unsigned long)(&bInitConv)));
(p_OpsTravLifULInitDone=((unsigned long)(&bOpsInitDone)));
(p_OpsTravLifULUSComm=((unsigned long)(&bUSComm)));
(p_OpsTravLifULEntBrd=((unsigned long)(&bEntBrd)));
(p_OpsTravLifULDSComm=((unsigned long)(&bDSComm)));
(p_OpsTravLifULExitBrd=((unsigned long)(&bExitBrd)));
(p_OpsTravLifULTravLifMov=((unsigned long)(&bTravLifMove)));
(p_OpsTravLifULUSWidthChkBrdExist=((unsigned long)(&bUSWidthChkBrdExist)));
(p_OpsTravLifULStpExt=((unsigned long)(&bStopperExtStep)));

(p_OpsTravLifULJogSpeed=((unsigned long)(&udiJogSpeed)));

(p_OpsTravLifULSelfTest=((unsigned long)(&bSelfTest)));
(p_OpsTravLifULInDSPos=((unsigned long)(&bTravLifInDSPos)));

(p_OpsTravLifULBypCurtainLED=((unsigned long)(&bBypCurtainSensorPBLED)));
(p_OpsTravLifULBypCurtainSenCtrl=((unsigned long)(&bBypCurtainSenCtrl)));

(p_OpsTravLifULTravGotoChkPt=((unsigned long)(&bTravGoToChkPt)));
(p_OpsTravLifULMagWidthChk=((unsigned long)(&bMagWidthChk)));
(p_OpsTravLifULMagWidthChkStep=((unsigned long)(&usiMagWidthChkStep)));

(p_OpsTravLifULTopScan=((unsigned long)(&eTCPTopAct)));
(p_OpsTravLifULBtmScan=((unsigned long)(&eTCPBtmAct)));
(p_OpsTravLifULBarcode=((unsigned long)(&sBarcode)));
(p_OpsTravLifULMsgReq=((unsigned long)(&tyOpConMsgReq)));
(p_OpsTravLifULPartProcessItms=((unsigned long)(&tyPartProcessedItems)));
(p_OpsTravLifULMagEntered=((unsigned long)(&asMagEntered)));

(p_OpsTravLifWChkErrCmdUnclmp1=((unsigned long)(&bWidthChkErrCmdUnclmp1)));
(p_OpsTravLifWChkErrCmdUnclmp2=((unsigned long)(&bWidthChkErrCmdUnclmp2)));
(p_OpsTravLifWChkErrCmdUnclmp3=((unsigned long)(&bWidthChkErrCmdUnclmp3)));

(p_OpsTravLifParamTravLif=((unsigned long)(&tyParamTravLif)));

(p_OpsTravLifOpsModGonethrough=((unsigned long)(&bOpsModGonethrough)));


(p_OpsTravLifWGdBrdChk=((unsigned long)(&bGdChk)));
(p_OpsTravLifAllwExitMag1=((unsigned long)(&bAllwExitMag1)));
(p_OpsTravLifAllwExitMag2=((unsigned long)(&bAllwExitMag2)));
(p_OpsTravLifAllwExitMag3=((unsigned long)(&bAllwExitMag3)));


(p_OpsTravLifInletStprAct=((unsigned long)(&eInletStopperAct)));



(p_OpsTravLifStartScanSig=((unsigned long)(&bStartScanSig)));
(p_OpsTravLifMag1TransOut=((unsigned long)(&bPCBExitMag1)));
(p_OpsTravLifMag2TransOut=((unsigned long)(&bPCBExitMag2)));
(p_OpsTravLifMag3TransOut=((unsigned long)(&bPCBExitMag3)));


(p_OpsTravLifOpsStep=((unsigned long)(&eOpsStep)));
(p_OpsTravLifGotoOpsStep=((unsigned long)(&eGotoOpsStep)));


}}
#line 96 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/OpsTravLifUL/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/OpsTravLif/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/OpsTravLif/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Operations/OpsTravLifUL/Init.st\\\"\\n\"");
__asm__(".previous");
