...
#include "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/PshrConv/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Conv/PshrConv/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Conv/PshrConv/Init.st"
...
(p_PshrConvStat=((unsigned long)(&eStat)));
(p_PshrConvStatus=((unsigned long)(&eStatus)));
(p_PshrConvStatTxt=((unsigned long)(&sStatTxt)));


(p_PshrConvAlmData=((unsigned long)(&tyAlmData)));


(p_PshrConvHvBrd=((unsigned long)(&bHvBrd)));
(p_PshrConvRejHvBrd=((unsigned long)(&bRejHvBrd)));
(p_PshrConvInspHvBrd=((unsigned long)(&bInspHvBrd)));
(p_PshrConvGdBrd=((unsigned long)(&bGdBrd)));
(p_PshrConvLmtSenActivated=((unsigned long)(&bLmtSenActivated)));
(p_PshrConvMtrSigOnOrLToR=((unsigned long)(&bMtrSigOnOrLToR)));
(p_PshrConvMtrDirOrRToL=((unsigned long)(&bMtrDirOrRToL)));

(p_PshrConvPshrExtCtrl=((unsigned long)(&bPshrExtCtrl)));
(p_PshrConvPshrRetCtrl=((unsigned long)(&bPshrRetCtrl)));
(p_PshrConvPshrTwoOutputControl=((unsigned long)(&bPshrTwoOutputControl)));
(p_PshrConvPshrExtended=((unsigned long)(&bPshrExtended)));
(p_PshrConvPshrRetracted=((unsigned long)(&bPshrRetracted)));

(p_PshrConvPullerExtCtrl=((unsigned long)(&bPullerExtCtrl)));
(p_PshrConvPullerRetCtrl=((unsigned long)(&bPullerRetCtrl)));
(p_PshrConvPullerTwoOutputControl=((unsigned long)(&bPullerTwoOutputControl)));
(p_PshrConvPullerExtended=((unsigned long)(&bPullerExtended)));
(p_PshrConvPullerRetracted=((unsigned long)(&bPullerRetracted)));

(p_PshrConvRotRemoteCtrl=((unsigned long)(&bRotRemoteCtrl)));
(p_PshrConvRotTwoOutputControl=((unsigned long)(&bRotTwoOutputControl)));
(p_PshrConvRotAtRemote=((unsigned long)(&bRotAtRemote)));
(p_PshrConvRotAtHome=((unsigned long)(&bRotAtHome)));

(p_PshrConvRejectUpCtrl=((unsigned long)(&bRejectUpCtrl)));
(p_PshrConvRejectDownCtrl=((unsigned long)(&bRejectDownCtrl)));
(p_PshrConvRejectTwoOutputControl=((unsigned long)(&bRejectTwoOutputControl)));
(p_PshrConvRejectAtUp=((unsigned long)(&bRejectAtUp)));
(p_PshrConvRejectAtDown=((unsigned long)(&bRejectAtDown)));


(p_PshrConvPshrRetAllwTrav=((unsigned long)(&bPshrRetAllwTraverse)));



}}
#line 55 "C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Conv/PshrConv/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/PshrConv/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Temp/Objects/23Mag_UL_MagPlatORLifTrav_Estun_laneMag/X20CP0483/PshrConv/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Github/NAEUL004/NAEUL004C00R13L515F00/Logical/Conv/PshrConv/Init.st\\\"\\n\"");
__asm__(".previous");
